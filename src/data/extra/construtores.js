...
export const atividadesExtraPorFaixa = [
  ...
  {
    id: 'con_memoria_corpo',
    tipo: 'memoria',
    titulo: 'Partes do Corpo',
    descricao: 'Combine cada órgão com o que ele faz!',
    emoji: '🫀',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'Seu corpo é uma equipe: cada parte tem uma função. 🫀 Encontre os pares e descubra quem faz o quê aí dentro.',
    pares: [
      { emoji: '🫀', nome: 'Coração', info: 'Bombeia sangue o dia inteiro' },
      { emoji: '🫁', nome: 'Pulmão', info: 'Enche de ar quando você respira' },
      { emoji: '🧠', nome: 'Cérebro', info: 'Comanda tudo no corpo' },
      { emoji: '🦴', nome: 'Osso', info: 'Dá sustentação e protege' },
      { emoji: '👁️', nome: 'Olho', info: 'Transforma luz em imagem' },
      { emoji: '👂', nome: 'Ouvido', info: 'Capta o som e ajuda no equilíbrio' },
      { emoji: '🦷', nome: 'Dente', info: 'Corta e tritura a comida' },
      { emoji: '💪', nome: 'Músculo', info: 'Puxa os ossos e faz você se mexer' },
    ],
  },
  {
    id: 'con_memoria_planetas',
    tipo: 'memoria',
    titulo: 'Planetas do Sistema Solar',
    descricao: 'Combine cada planeta com sua marca!',
    emoji: '🪐',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'Oito planetas giram em volta do Sol, cada um bem diferente. 🪐 Encontre os pares e faça a viagem.',
    pares: [
      { emoji: '☀️', nome: 'Mercúrio', info: 'O mais perto do Sol' },
      { emoji: '🌕', nome: 'Vênus', info: 'O mais quente de todos' },
      { emoji: '🌍', nome: 'Terra', info: 'O único com vida conhecida' },
      { emoji: '🔴', nome: 'Marte', info: 'Vermelho por causa da ferrugem' },
      { emoji: '🌪️', nome: 'Júpiter', info: 'O maior, com uma tempestade gigante' },
      { emoji: '🪐', nome: 'Saturno', info: 'Tem anéis de gelo e pedra' },
      { emoji: '🧊', nome: 'Urano', info: 'Gira deitado de lado' },
      { emoji: '💙', nome: 'Netuno', info: 'O mais distante e ventoso' },
    ],
  },
  {
    id: 'con_memoria_dinos',
    tipo: 'memoria',
    titulo: 'Dinossauros',
    descricao: 'Combine cada dinossauro com sua marca!',
    emoji: '🦕',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'Eles viveram muito antes de existir gente! 🦕 Encontre os pares e conheça cada um.',
    pares: [
      { emoji: '🦖', nome: 'Tiranossauro', info: 'Dentes enormes e braços curtos' },
      { emoji: '🦕', nome: 'Braquiossauro', info: 'Pescoço comprido para alcançar folhas' },
      { emoji: '🛡️', nome: 'Triceratops', info: 'Três chifres e uma gola óssea' },
      { emoji: '🪶', nome: 'Velociraptor', info: 'Pequeno, rápido e com penas' },
      { emoji: '🔺', nome: 'Estegossauro', info: 'Placas nas costas e espinhos na cauda' },
      { emoji: '🌊', nome: 'Espinossauro', info: 'Caçava peixe e nadava bem' },
      { emoji: '🦅', nome: 'Pterossauro', info: 'Voava, mas não era dinossauro' },
      { emoji: '🥚', nome: 'Ovo fóssil', info: 'Conta como eles nasciam' },
    ],
  },
  {
    id: 'con_memoria_folclore',
    tipo: 'memoria',
    titulo: 'Folclore Brasileiro',
    descricao: 'Combine cada personagem com sua história!',
    emoji: '🎭',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'Histórias contadas há muito tempo, de avó para neto. 🎭 Encontre os pares do folclore do Brasil.',
    pares: [
      { emoji: '🦶', nome: 'Curupira', info: 'Tem os pés virados para trás' },
      { emoji: '🐬', nome: 'Boto-cor-de-rosa', info: 'Vira moço nas festas do rio' },
      { emoji: '🔥', nome: 'Boitatá', info: 'Cobra de fogo que protege a mata' },
      { emoji: '👦', nome: 'Saci', info: 'Uma perna só e um gorro vermelho' },
      { emoji: '🐴', nome: 'Mula sem cabeça', info: 'Corre soltando fogo' },
      { emoji: '🧜', nome: 'Iara', info: 'Mãe-d\'água que encanta com o canto' },
      { emoji: '🌳', nome: 'Caipora', info: 'Guardiã dos animais da floresta' },
      { emoji: '👵', nome: 'Cuca', info: 'A velha do sono das cantigas' },
    ],
  },
  {
    id: 'con_memoria_reciclagem',
    tipo: 'memoria',
    titulo: 'Reciclagem',
    descricao: 'Combine cada material com sua lixeira!',
    emoji: '♻️',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'Separar o lixo é o que faz a reciclagem funcionar. ♻️ Encontre os pares e aprenda a cor de cada um.',
    pares: [
      { emoji: '🟦', nome: 'Papel', info: 'Lixeira azul' },
      { emoji: '🟥', nome: 'Plástico', info: 'Lixeira vermelha' },
      { emoji: '🟩', nome: 'Vidro', info: 'Lixeira verde' },
      { emoji: '🟨', nome: 'Metal', info: 'Lixeira amarela' },
      { emoji: '🟫', nome: 'Orgânico', info: 'Vira adubo para as plantas' },
      { emoji: '🔋', nome: 'Pilha', info: 'Precisa de ponto de coleta especial' },
      { emoji: '💻', nome: 'Eletrônico', info: 'Não pode ir no lixo comum' },
      { emoji: '🛢️', nome: 'Óleo de cozinha', info: 'Um litro suja muita água' },
    ],
  },
  {
    id: 'con_memoria_ferramentas',
    tipo: 'memoria',
    titulo: 'Ferramentas',
    descricao: 'Combine cada ferramenta com sua função!',
    emoji: '🔨',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'Na bancada tem uma ferramenta certa para cada serviço. 🔨 Encontre os pares e monte sua caixa.',
    pares: [
      { emoji: '🔨', nome: 'Martelo', info: 'Bate o prego na madeira' },
      { emoji: '🪛', nome: 'Chave de fenda', info: 'Aperta e solta parafuso' },
      { emoji: '🔧', nome: 'Chave inglesa', info: 'Aperta porcas de tamanhos vários' },
      { emoji: '📏', nome: 'Régua', info: 'Mede e risca reto' },
      { emoji: '✂️', nome: 'Tesoura', info: 'Corta papel e tecido' },
      { emoji: '🪚', nome: 'Serrote', info: 'Corta madeira com dentes' },
      { emoji: '🧲', nome: 'Ímã', info: 'Atrai metal e acha o prego caído' },
      { emoji: '🔦', nome: 'Lanterna', info: 'Ilumina o canto escuro' },
    ],
  },
  {
    id: 'con_memoria_ritmos',
    tipo: 'memoria',
    titulo: 'Ritmos do Brasil',
    descricao: 'Combine cada ritmo com sua terra!',
    emoji: '🎶',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'O Brasil inteiro canta, e cada região tem o seu balanço. 🎶 Encontre os pares e dance junto.',
    pares: [
      { emoji: '🥁', nome: 'Samba', info: 'Nasceu no Rio de Janeiro' },
      { emoji: '🪗', nome: 'Forró', info: 'A sanfona manda no Nordeste' },
      { emoji: '🎸', nome: 'Sertanejo', info: 'Viola caipira do interior' },
      { emoji: '🌴', nome: 'Frevo', info: 'Sombrinha e passo rápido no Recife' },
      { emoji: '🌊', nome: 'Maracatu', info: 'Tambores fortes de Pernambuco' },
      { emoji: '🎺', nome: 'Choro', info: 'O primeiro ritmo urbano brasileiro' },
      { emoji: '💃', nome: 'Axé', info: 'Alegria da Bahia' },
      { emoji: '🌳', nome: 'Carimbó', info: 'Ritmo do Pará, vindo da floresta' },
    ],
  },
  {
    id: 'con_memoria_dinheiro',
    tipo: 'memoria',
    titulo: 'Dinheiro e Troco',
    descricao: 'Combine cada valor com o que ele compra!',
    emoji: '💰',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'Saber contar dinheiro dá independência! 💰 Encontre os pares e treine o troco.',
    pares: [
      { emoji: '🪙', nome: '5 centavos', info: 'A menor moeda que ainda circula' },
      { emoji: '🥉', nome: '25 centavos', info: 'Quatro delas fazem 1 real' },
      { emoji: '🥈', nome: '50 centavos', info: 'Duas fazem 1 real' },
      { emoji: '🥇', nome: '1 real', info: 'Moeda com borda dourada' },
      { emoji: '💵', nome: '2 reais', info: 'A menor nota, azul' },
      { emoji: '💴', nome: '5 reais', info: 'Nota roxa, com a garça' },
      { emoji: '💶', nome: '10 reais', info: 'Nota vermelha, com a arara' },
      { emoji: '💷', nome: '50 reais', info: 'Nota marrom, com a onça' },
    ],
  },
  {
    id: 'con_memoria_transito',
    tipo: 'memoria',
    titulo: 'Placas de Trânsito',
    descricao: 'Combine cada sinal com seu recado!',
    emoji: '🚦',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'As placas conversam com quem anda na rua, sem dizer palavra. 🚦 Encontre os pares e leia o que cada uma diz.',
    pares: [
      { emoji: '🛑', nome: 'Pare', info: 'Octogonal e vermelha' },
      { emoji: '🚸', nome: 'Escola', info: 'Cuidado: criança atravessando' },
      { emoji: '🚦', nome: 'Semáforo', info: 'Verde segue, amarelo atenção, vermelho para' },
      { emoji: '🚷', nome: 'Proibido pedestre', info: 'Não pode passar a pé' },
      { emoji: '🅿️', nome: 'Estacionamento', info: 'Aqui pode parar o carro' },
      { emoji: '⚠️', nome: 'Atenção', info: 'Triângulo amarelo avisa perigo' },
      { emoji: '↩️', nome: 'Retorno', info: 'Pode voltar pelo outro lado' },
      { emoji: '🚳', nome: 'Proibido bicicleta', info: 'Trecho sem passagem para bike' },
    ],
  },
  {
    id: 'con_memoria_regioes',
    tipo: 'memoria',
    titulo: 'Regiões do Brasil',
    descricao: 'Combine cada região com sua marca!',
    emoji: '🗺️',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'O Brasil é grande demais para ser só um lugar. 🗺️ Encontre os pares e conheça as cinco regiões.',
    pares: [
      { emoji: '🌳', nome: 'Norte', info: 'Tem a maior floresta do mundo' },
      { emoji: '🌵', nome: 'Nordeste', info: 'Praias famosas e o sertão' },
      { emoji: '🏙️', nome: 'Sudeste', info: 'Onde vive mais gente' },
      { emoji: '🌾', nome: 'Centro-Oeste', info: 'Cerrado, Pantanal e Brasília' },
      { emoji: '🧊', nome: 'Sul', info: 'A região mais fria do país' },
      { emoji: '🌊', nome: 'Amazonas', info: 'O maior rio em volume de água' },
      { emoji: '🐆', nome: 'Pantanal', info: 'A maior planície alagada do planeta' },
      { emoji: '🏛️', nome: 'Brasília', info: 'Capital construída do zero' },
    ],
  },
  {
    id: 'con_memoria_comidas',
    tipo: 'memoria',
    titulo: 'Comidas do Mundo',
    descricao: 'Combine cada prato com seu país!',
    emoji: '🍜',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'Cada país tem um prato que é a cara dele. 🍜 Encontre os pares e dê a volta ao mundo comendo.',
    pares: [
      { emoji: '🍕', nome: 'Pizza', info: 'Da Itália' },
      { emoji: '🍣', nome: 'Sushi', info: 'Do Japão' },
      { emoji: '🌮', nome: 'Taco', info: 'Do México' },
      { emoji: '🥐', nome: 'Croissant', info: 'Da França' },
      { emoji: '🍜', nome: 'Lámen', info: 'Da China e do Japão' },
      { emoji: '🥘', nome: 'Feijoada', info: 'Do Brasil' },
      { emoji: '🥙', nome: 'Falafel', info: 'Do Oriente Médio' },
      { emoji: '🥟', nome: 'Empanada', info: 'Da Argentina' },
    ],
  },
  {
    id: 'con_memoria_insetos',
    tipo: 'memoria',
    titulo: 'Insetos',
    descricao: 'Combine cada inseto com o que ele faz!',
    emoji: '🐝',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'Os insetos são a maioria dos animais do planeta. 🐝 Encontre os pares e veja o trabalho de cada um.',
    pares: [
      { emoji: '🐝', nome: 'Abelha', info: 'Poliniza as flores e faz mel' },
      { emoji: '🐜', nome: 'Formiga', info: 'Carrega até 50 vezes o próprio peso' },
      { emoji: '🦋', nome: 'Borboleta', info: 'Passa por metamorfose completa' },
      { emoji: '🪲', nome: 'Besouro', info: 'O grupo com mais espécies do mundo' },
      { emoji: '🦟', nome: 'Mosquito', info: 'Só a fêmea pica' },
      { emoji: '🦗', nome: 'Gafanhoto', info: 'Pula muitas vezes o próprio tamanho' },
      { emoji: '🪳', nome: 'Barata', info: 'Existe desde antes dos dinossauros' },
      { emoji: '🕸️', nome: 'Aranha', info: 'Não é inseto: tem oito patas' },
    ],
  },
  {
    id: 'con_memoria_energia',
    tipo: 'memoria',
    titulo: 'De Onde Vem a Energia',
    descricao: 'Combine cada fonte com sua origem!',
    emoji: '⚡',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'A luz da sua casa começou longe dali. ⚡ Encontre os pares e descubra de onde ela vem.',
    pares: [
      { emoji: '💧', nome: 'Hidrelétrica', info: 'A força da água girando turbinas' },
      { emoji: '☀️', nome: 'Solar', info: 'Painéis captam a luz do Sol' },
      { emoji: '🌬️', nome: 'Eólica', info: 'O vento gira as pás gigantes' },
      { emoji: '🔥', nome: 'Termelétrica', info: 'Queima combustível para gerar calor' },
      { emoji: '🌋', nome: 'Geotérmica', info: 'Calor de dentro da Terra' },
      { emoji: '🌾', nome: 'Biomassa', info: 'Restos de plantas viram combustível' },
      { emoji: '🌊', nome: 'Maremotriz', info: 'Aproveita a subida e descida da maré' },
      { emoji: '⚛️', nome: 'Nuclear', info: 'Energia guardada dentro do átomo' },
    ],
  },
  {
    id: 'con_memoria_horas',
    tipo: 'memoria',
    titulo: 'As Horas do Dia',
    descricao: 'Combine cada horário com o que acontece!',
    emoji: '⏰',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'O dia tem 24 horas e cada pedaço tem seu nome. ⏰ Encontre os pares e organize sua rotina.',
    pares: [
      { emoji: '🌅', nome: 'Amanhecer', info: 'O Sol aparece no horizonte' },
      { emoji: '🍳', nome: 'Manhã', info: 'Hora do café e da escola' },
      { emoji: '☀️', nome: 'Meio-dia', info: 'O Sol fica bem no alto' },
      { emoji: '🍽️', nome: 'Tarde', info: 'Depois do almoço até escurecer' },
      { emoji: '🌇', nome: 'Entardecer', info: 'O céu fica laranja' },
      { emoji: '🌆', nome: 'Noite', info: 'As luzes da cidade acendem' },
      { emoji: '🌙', nome: 'Madrugada', info: 'Quase todo mundo dormindo' },
      { emoji: '⏳', nome: 'Uma hora', info: 'Tem 60 minutos' },
    ],
  },
  {
    id: 'con_memoria_arvores',
    tipo: 'memoria',
    titulo: 'Árvores do Brasil',
    descricao: 'Combine cada árvore com sua marca!',
    emoji: '🌳',
    habilidade: 'Memória Visual',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 7,
    historinha: 'Árvore não é tudo igual: cada uma tem folha, fruto e história própria. 🌳 Encontre os pares.',
    pares: [
      { emoji: '🌳', nome: 'Pau-brasil', info: 'Deu nome ao país' },
      { emoji: '🥥', nome: 'Coqueiro', info: 'Dá fruto com água dentro' },
      { emoji: '🌰', nome: 'Castanheira', info: 'Vive mais de 500 anos na Amazônia' },
      { emoji: '🍇', nome: 'Jabuticabeira', info: 'O fruto nasce no tronco' },
      { emoji: '🌵', nome: 'Mandacaru', info: 'Guarda água para a seca' },
      { emoji: '🍃', nome: 'Ipê', info: 'Floresce toda amarela na seca' },
      { emoji: '🌲', nome: 'Araucária', info: 'O pinheiro do Sul, dá pinhão' },
      { emoji: '🫘', nome: 'Seringueira', info: 'Dá o látex que vira borracha' },
    ],
  },
]
...
export const fase2ExtraPorFaixa = [
  ...
  {
    id: 'con_labirinto_biblioteca',
    tipo: 'labirinto',
    titulo: 'Biblioteca Secreta',
    descricao: 'Ache o livro escondido nas estantes.',
    emoji: '📚',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'Dizem que existe um livro que ninguém nunca leu, escondido no fundo da biblioteca. 📚 As estantes formam corredores — encontre ele antes que a biblioteca feche.',
    tamanho: 7,
  },
  {
    id: 'con_labirinto_museu',
    tipo: 'labirinto',
    titulo: 'Museu à Noite',
    descricao: 'Atravesse as salas até a saída.',
    emoji: '🏛️',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'As luzes do museu se apagaram com você lá dentro! 🏛️ Atravesse as salas de exposição no escuro e ache a porta de saída.',
    tamanho: 7,
  },
  {
    id: 'con_labirinto_vulcao',
    tipo: 'labirinto',
    titulo: 'Ilha do Vulcão',
    descricao: 'Chegue ao barco antes da erupção!',
    emoji: '🌋',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'O vulcão começou a roncar! 🌋 Desça a trilha da ilha e chegue ao barco antes que a lava alcance o caminho.',
    tamanho: 7,
  },
  {
    id: 'con_labirinto_castelo_gelo',
    tipo: 'labirinto',
    titulo: 'Castelo de Gelo',
    descricao: 'Ache o salão do trono congelado.',
    emoji: '🏰',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'Um castelo inteiro feito de gelo, com paredes que brilham! 🏰 Os corredores são escorregadios — ache o salão do trono.',
    tamanho: 7,
  },
  {
    id: 'con_labirinto_amazonia',
    tipo: 'labirinto',
    titulo: 'Trilha da Amazônia',
    descricao: 'Siga o rio até a aldeia.',
    emoji: '🌳',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'A floresta é tão fechada que o sol quase não entra. 🌳 Siga o barulho do rio por entre as árvores até chegar na aldeia.',
    tamanho: 9,
  },
  {
    id: 'con_labirinto_navio',
    tipo: 'labirinto',
    titulo: 'Navio Pirata',
    descricao: 'Encontre o baú no porão.',
    emoji: '⚓',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'O navio está parado há cem anos, e o tesouro continua lá embaixo. ⚓ Desça pelos corredores do porão e ache o baú.',
    tamanho: 9,
  },
  {
    id: 'con_labirinto_fabrica',
    tipo: 'labirinto',
    titulo: 'Fábrica de Chocolate',
    descricao: 'Siga a esteira até a sala secreta.',
    emoji: '🍫',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'Esteiras carregando chocolate para todo lado! 🍫 Siga a esteira certa e descubra a sala onde as receitas são guardadas.',
    tamanho: 9,
  },
  {
    id: 'con_labirinto_deserto',
    tipo: 'labirinto',
    titulo: 'Duna do Deserto',
    descricao: 'Ache o oásis antes do sol se pôr.',
    emoji: '🐪',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'As dunas mudam de lugar com o vento e todas parecem iguais. 🐪 Ache o oásis antes do sol se pôr.',
    tamanho: 9,
  },
  {
    id: 'con_labirinto_montanha',
    tipo: 'labirinto',
    titulo: 'Pico da Montanha',
    descricao: 'Chegue ao cume pela trilha certa.',
    emoji: '⛰️',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'A trilha se divide várias vezes e só uma leva ao cume. ⛰️ Escolha com calma: voltar cansa mais do que subir.',
    tamanho: 9,
  },
  {
    id: 'con_labirinto_metro',
    tipo: 'labirinto',
    titulo: 'Estação de Metrô',
    descricao: 'Ache a plataforma da linha azul.',
    emoji: '🚇',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'A estação tem três andares e placas apontando para todo lado. 🚇 Encontre a plataforma da linha azul.',
    tamanho: 9,
  },
  {
    id: 'con_labirinto_botanico',
    tipo: 'labirinto',
    titulo: 'Jardim Botânico',
    descricao: 'Chegue à estufa das orquídeas.',
    emoji: '🌺',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'Os caminhos do jardim botânico foram desenhados como um labirinto de verdade. 🌺 Chegue até a estufa das orquídeas.',
    tamanho: 9,
  },
  {
    id: 'con_labirinto_mina',
    tipo: 'labirinto',
    titulo: 'Mina de Cristais',
    descricao: 'Ache a veia de cristais.',
    emoji: '💎',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'Lá no fundo da mina existe uma parede coberta de cristais que brilham sozinhos. 💎 Os túneis se cruzam — ache o caminho.',
    tamanho: 11,
  },
  {
    id: 'con_labirinto_pantano',
    tipo: 'labirinto',
    titulo: 'Pântano Misterioso',
    descricao: 'Pule de pedra em pedra até a cabana.',
    emoji: '🐊',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'No pântano só dá para andar em cima das pedras. 🐊 Um passo errado e você afunda na lama. Chegue até a cabana.',
    tamanho: 11,
  },
  {
    id: 'con_labirinto_torre',
    tipo: 'labirinto',
    titulo: 'Torre do Relógio',
    descricao: 'Suba até os ponteiros.',
    emoji: '🕰️',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'A torre do relógio tem escadas em espiral e engrenagens girando. 🕰️ Suba até o topo antes do relógio bater a hora.',
    tamanho: 11,
  },
  {
    id: 'con_labirinto_celeiro',
    tipo: 'labirinto',
    titulo: 'Celeiro Antigo',
    descricao: 'Ache a saída entre os fardos.',
    emoji: '🌾',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 80,
    coins_reward: 80,
    tempo_estimado: 8,
    historinha: 'Os fardos de feno foram empilhados formando corredores enormes. 🌾 Ache a saída antes que anoiteça no campo.',
    tamanho: 11,
  },
]
...
export const quizExtraPorFaixa = [
  ...
  {
    id: 'con_quiz_folclore',
    tipo: 'quiz',
    titulo: 'Folclore Brasileiro',
    descricao: 'Histórias que o Brasil conta há muito tempo!',
    emoji: '🎭',
    habilidade: 'Conhecimento Geral',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 7,
    historinha: 'Antes da televisão, as histórias passavam de boca em boca. 🎭 Quanto você sabe do nosso folclore?',
    perguntas: [
      {
        pergunta: 'Qual personagem tem os pés virados para trás?',
        opcoes: ['Curupira', 'Saci', 'Iara', 'Boitatá'],
        correta: 0,
        fato: '🦶 O Curupira protege a floresta. Os pés virados confundem quem tenta seguir seu rastro!',
      },
      {
        pergunta: 'O Saci tem quantas pernas?',
        opcoes: ['Uma', 'Duas', 'Três', 'Nenhuma'],
        correta: 0,
        fato: '👦 O Saci pula numa perna só, usa gorro vermelho e adora aprontar. Vive dentro de redemoinhos!',
      },
      {
        pergunta: 'Quem é a mãe-d\'água que encanta com o canto?',
        opcoes: ['Iara', 'Cuca', 'Caipora', 'Mula sem cabeça'],
        correta: 0,
        fato: '🧜 A Iara canta tão bonito que atrai quem passa perto do rio. A lenda vem dos povos indígenas.',
      },
      {
        pergunta: 'O Boitatá é uma cobra de...',
        opcoes: ['Fogo', 'Gelo', 'Papel', 'Areia'],
        correta: 0,
        fato: '🔥 O Boitatá é uma cobra de fogo que protege a mata de quem coloca fogo nela.',
      },
      {
        pergunta: 'De onde vêm muitas lendas do nosso folclore?',
        opcoes: ['Povos indígenas, africanos e europeus', 'Só da Europa', 'Só dos Estados Unidos', 'De desenhos animados'],
        correta: 0,
        fato: '🇧🇷 O folclore brasileiro é uma mistura: cada povo que formou o país trouxe suas histórias.',
      },
    ],
  },
  {
    id: 'con_quiz_invencoes',
    tipo: 'quiz',
    titulo: 'Invenções que Mudaram Tudo',
    descricao: 'Quem inventou o quê?',
    emoji: '💡',
    habilidade: 'Conhecimento Geral',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 7,
    historinha: 'Alguém teve que inventar tudo o que você usa hoje! 💡 Vamos conhecer algumas dessas ideias.',
    perguntas: [
      {
        pergunta: 'O que a roda facilitou?',
        opcoes: ['Transportar coisas pesadas', 'Fazer comida', 'Ler à noite', 'Conversar longe'],
        correta: 0,
        fato: '🛞 Com a roda, arrastar virou rolar — e mover peso ficou muito mais fácil.',
      },
      {
        pergunta: 'Brasileiro famoso pelo avião 14-Bis:',
        opcoes: ['Santos Dumont', 'Dom Pedro II', 'Machado de Assis', 'Oscar Niemeyer'],
        correta: 0,
        fato: '✈️ Em 1906, em Paris, o 14-Bis decolou sozinho diante de uma plateia — feito registrado e aplaudido.',
      },
      {
        pergunta: 'Para que serve a imprensa de Gutenberg?',
        opcoes: ['Imprimir livros em série', 'Cozinhar', 'Medir tempo', 'Transportar água'],
        correta: 0,
        fato: '📚 Antes dela, copiar um livro à mão levava meses. Com ela, o conhecimento se espalhou.',
      },
      {
        pergunta: 'O que a lâmpada elétrica mudou?',
        opcoes: ['Poder trabalhar e estudar à noite', 'O sabor da comida', 'A cor do céu', 'O peso das coisas'],
        correta: 0,
        fato: '💡 Com luz elétrica a noite deixou de ser um limite: cidades e fábricas passaram a funcionar mais tempo.',
      },
      {
        pergunta: 'A geladeira serve para...',
        opcoes: ['Conservar alimentos pelo frio', 'Esquentar comida', 'Lavar roupa', 'Fazer barulho'],
        correta: 0,
        fato: '🧊 O frio deixa as bactérias mais lentas, e por isso a comida demora mais para estragar.',
      },
    ],
  },
  {
    id: 'con_quiz_corpo_saude',
    tipo: 'quiz',
    titulo: 'Corpo e Saúde',
    descricao: 'Como cuidar bem do seu corpo!',
    emoji: '🏃',
    habilidade: 'Conhecimento Geral',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 7,
    historinha: 'Seu corpo trabalha o dia inteiro por você. 🏃 Que tal aprender a cuidar dele?',
    perguntas: [
      {
        pergunta: 'Quantas horas de sono uma criança de 7 anos precisa?',
        opcoes: ['9 a 11 horas', '3 horas', '5 horas', '15 horas'],
        correta: 0,
        fato: '😴 Dormir é quando o corpo cresce e o cérebro guarda o que você aprendeu no dia.',
      },
      {
        pergunta: 'Por que é importante beber água?',
        opcoes: ['O corpo é feito de muita água', 'Para ficar pesado', 'Para não comer', 'Para crescer o cabelo'],
        correta: 0,
        fato: '💧 Cerca de 60% do corpo humano é água. Ela leva nutrientes e controla a temperatura.',
      },
      {
        pergunta: 'O que os músculos precisam para ficar fortes?',
        opcoes: ['Movimento e comida boa', 'Ficar parado', 'Só assistir TV', 'Dormir o dia todo'],
        correta: 0,
        fato: '💪 Músculo que se mexe fica mais forte; músculo parado por muito tempo enfraquece.',
      },
      {
        pergunta: 'Escovar os dentes serve para...',
        opcoes: ['Tirar a placa que causa cárie', 'Deixar o dente colorido', 'Fazer o dente crescer', 'Trocar o dente'],
        correta: 0,
        fato: '🦷 A placa é uma camada de bactérias. Escovando você tira ela antes que ataque o dente.',
      },
      {
        pergunta: 'Lavar as mãos evita...',
        opcoes: ['Que germes entrem no corpo', 'Que a pele cresça', 'Que a unha caia', 'O frio'],
        correta: 0,
        fato: '🧼 A mão toca tudo. Lavar com sabão por 20 segundos remove a maior parte dos germes.',
      },
    ],
  },
  {
    id: 'con_quiz_transito',
    tipo: 'quiz',
    titulo: 'Trânsito Seguro',
    descricao: 'As regras que protegem todo mundo!',
    emoji: '🚦',
    habilidade: 'Conhecimento Geral',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 7,
    historinha: 'A rua é de todo mundo, e as regras existem para todos chegarem bem. 🚦 Vamos revisar?',
    perguntas: [
      {
        pergunta: 'O sinal amarelo quer dizer...',
        opcoes: ['Atenção, vai fechar', 'Pode acelerar', 'Pare já', 'Siga tranquilo'],
        correta: 0,
        fato: '🟡 Amarelo é aviso: quem ainda não entrou no cruzamento deve parar com segurança.',
      },
      {
        pergunta: 'Pedestre deve atravessar...',
        opcoes: ['Na faixa', 'No meio da rua', 'Correndo entre carros', 'De olhos fechados'],
        correta: 0,
        fato: '🚶 A faixa é o lugar onde o motorista espera encontrar gente atravessando.',
      },
      {
        pergunta: 'Quem anda de bicicleta deve usar...',
        opcoes: ['Capacete', 'Chinelo', 'Fone alto', 'Guarda-chuva'],
        correta: 0,
        fato: '🚲 O capacete protege a cabeça, que é a parte mais frágil numa queda.',
      },
      {
        pergunta: 'A placa octogonal vermelha significa...',
        opcoes: ['Pare', 'Siga', 'Vire', 'Estacione'],
        correta: 0,
        fato: '🛑 O formato de oito lados é reconhecido no mundo inteiro, mesmo sem ler a palavra.',
      },
      {
        pergunta: 'Por que existe faixa de pedestre elevada perto de escolas?',
        opcoes: ['Faz o carro reduzir', 'Deixa a rua bonita', 'Serve de banco', 'Junta água'],
        correta: 0,
        fato: '🚸 A elevação obriga o motorista a diminuir a velocidade justamente onde há criança.',
      },
    ],
  },
  {
    id: 'con_quiz_alimentacao',
    tipo: 'quiz',
    titulo: 'Comida de Verdade',
    descricao: 'O que o corpo ganha com cada alimento!',
    emoji: '🥗',
    habilidade: 'Conhecimento Geral',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 7,
    historinha: 'Comida não é só sabor: é combustível e material de construção. 🥗 Vamos entender?',
    perguntas: [
      {
        pergunta: 'Qual grupo dá mais energia rápida?',
        opcoes: ['Carboidratos', 'Água', 'Sal', 'Vitaminas'],
        correta: 0,
        fato: '🍞 Pão, arroz e batata são carboidratos: o corpo transforma em energia para o dia.',
      },
      {
        pergunta: 'Quem ajuda a construir músculo?',
        opcoes: ['Proteínas', 'Açúcar', 'Refrigerante', 'Sal'],
        correta: 0,
        fato: '🥚 Ovo, feijão, carne e leite têm proteína, que é material de construção do corpo.',
      },
      {
        pergunta: 'Fruta e verdura são ricas em...',
        opcoes: ['Vitaminas e fibras', 'Gordura', 'Sal', 'Corante'],
        correta: 0,
        fato: '🥦 Vitaminas ajudam o corpo a funcionar e as fibras ajudam o intestino a trabalhar.',
      },
      {
        pergunta: 'O que acontece se comer muito açúcar?',
        opcoes: ['Faz mal aos dentes e à saúde', 'Fica mais inteligente', 'Cresce mais rápido', 'Nada'],
        correta: 0,
        fato: '🍬 O açúcar alimenta as bactérias da boca e, em excesso, atrapalha o corpo inteiro.',
      },
      {
        pergunta: 'Comida ultraprocessada é aquela que...',
        opcoes: ['Tem muitos ingredientes de fábrica', 'Veio da horta', 'Foi feita em casa', 'É sempre saudável'],
        correta: 0,
        fato: '🏭 Salgadinho e refrigerante têm lista enorme de ingredientes. Comida de verdade tem lista curta.',
      },
    ],
  },
]
...
export const raciocinioExtraPorFaixa = [
  ...
  // ── lote 15/09/2026: sequência e padrão a 20 por faixa ───────────────
  {
    id: 'con_seq_de_tres',
    tipo: 'sequencia',
    titulo: 'De Três em Três',
    descricao: 'Some sempre a mesma quantidade!',
    emoji: '3️⃣',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 8,
    historinha: 'Contar de três em três é atalho para a tabuada do 3! 3️⃣ Descubra qual número vem agora.',
    sequencias: [
      { items: ['3', '6', '9', '12', '15', '❓'], resposta: '18', opcoes: ['19', '21', '15', '18'] },
      { items: ['6', '9', '12', '15', '18', '❓'], resposta: '21', opcoes: ['22', '24', '18', '21'] },
      { items: ['12', '15', '18', '21', '❓'], resposta: '24', opcoes: ['25', '27', '21', '24'] },
      { items: ['21', '24', '27', '30', '❓'], resposta: '33', opcoes: ['34', '36', '30', '33'] },
      { items: ['30', '33', '36', '39', '42', '❓'], resposta: '45', opcoes: ['42', '46', '48', '45'] },
    ],
  },
  {
    id: 'con_seq_semana',
    ...
    descricao: 'A semana sempre gira na mesma ordem!',
    emoji: '📅',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 8,
    historinha: 'A semana gira e volta ao começo, sempre igual! 📅 Qual dia vem depois?',
    sequencias: [
      { items: ['Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Seg', 'Ter', 'Qua', '❓'], resposta: 'Qui', opcoes: ['Qua', 'Sex', 'Qui', 'Ter'] },
      { items: ['Sáb', 'Dom', 'Sáb', 'Dom', 'Sáb', 'Dom', '❓'], resposta: 'Sáb', opcoes: ['Inverno', 'Verão', 'Sáb', 'Dom'] },
      { items: ['Manhã', 'Tarde', 'Noite', 'Manhã', 'Tarde', 'Noite', '❓'], resposta: 'Manhã', opcoes: ['Manhã', 'Prim.', 'Tarde', 'Noite'] },
      { items: ['Jan', 'Fev', 'Mar', 'Abr', 'Jan', 'Fev', 'Mar', '❓'], resposta: 'Abr', opcoes: ['Jan', 'Mar', 'Fev', 'Abr'] },
      { items: ['Verão', 'Outono', 'Inverno', 'Prim.', 'Verão', 'Outono', 'Inverno', 'Prim.', '❓'], resposta: 'Verão', opcoes: ['Prim.', 'Inverno', 'Outono', 'Verão'] },
    ],
  },
  {
    id: 'con_seq_moedas',
    tipo: 'sequencia',
    titulo: 'Contando Moedas',
    descricao: 'Some o valor das moedas!',
    emoji: '🪙',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 8,
    historinha: 'No cofrinho, cada moeda vale um tanto. 🪙 Some sempre o mesmo valor e diga quanto dá.',
    sequencias: [
      { items: ['25', '50', '75', '100', '❓'], resposta: '125', opcoes: ['100', '126', '150', '125'] },
      { items: ['50', '100', '150', '200', '❓'], resposta: '250', opcoes: ['200', '251', '300', '250'] },
      { items: ['10', '20', '30', '40', '50', '❓'], resposta: '60', opcoes: ['70', '61', '50', '60'] },
      { items: ['5', '10', '15', '20', '25', '30', '❓'], resposta: '35', opcoes: ['40', '36', '30', '35'] },
      { items: ['100', '200', '300', '400', '❓'], resposta: '500', opcoes: ['600', '501', '400', '500'] },
    ],
  },
  {
    id: 'con_seq_crescendo',
    tipo: 'sequencia',
    titulo: 'Figuras Crescendo',
    descricao: 'Cada figura ganha o mesmo tanto de lados!',
    emoji: '🔺',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 8,
    historinha: 'As figuras vão ganhando lados, sempre na mesma medida! 🔺 Quantos lados terá a próxima?',
    sequencias: [
      { items: ['3', '4', '5', '6', '7', '❓'], resposta: '8', opcoes: ['9', '10', '7', '8'] },
      { items: ['4', '6', '8', '10', '❓'], resposta: '12', opcoes: ['14', '13', '10', '12'] },
      { items: ['5', '10', '15', '20', '❓'], resposta: '25', opcoes: ['30', '26', '20', '25'] },
      { items: ['8', '12', '16', '20', '❓'], resposta: '24', opcoes: ['28', '25', '20', '24'] },
      { items: ['6', '12', '18', '24', '❓'], resposta: '30', opcoes: ['36', '31', '24', '30'] },
    ],
  },
  {
    id: 'con_seq_dobrando',
    tipo: 'sequencia',
    titulo: 'Dobrando Sempre',
    descricao: 'Cada número é o dobro do anterior!',
    emoji: '✖️',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 8,
    historinha: 'Dobrar parece pouco no começo e vira muito bem rápido! ✖️ Qual é o próximo dobro?',
    sequencias: [
      { items: ['1', '2', '4', '8', '16', '❓'], resposta: '32', opcoes: ['33', '64', '16', '32'] },
      { items: ['3', '6', '12', '24', '❓'], resposta: '48', opcoes: ['51', '96', '24', '48'] },
      { items: ['5', '10', '20', '40', '❓'], resposta: '80', opcoes: ['85', '160', '40', '80'] },
      { items: ['2', '6', '18', '54', '❓'], resposta: '162', opcoes: ['164', '486', '54', '162'] },
      { items: ['1', '10', '100', '1000', '❓'], resposta: '10000', opcoes: ['10001', '100000', '1000', '10000'] },
    ],
  },
  {
    id: 'con_padrao_linhas_tres',
    tipo: 'padrao',
    titulo: 'Linhas de Três em Três',
    descricao: 'Cada linha soma sempre o mesmo tanto.',
    emoji: '➕',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 8,
    historinha: 'Cada linha da matriz cresce no mesmo ritmo! ➕ Descubra o passo e complete.',
    puzzles: [
      { matriz: ['1', '2', '3', '4', '5', '6', '7', '8', '❓'], resposta: '9', opcoes: ['11', '10', '8', '9'], dica: 'Olhe UMA linha por vez: da esquerda para a direita, some sempre o mesmo número.' },
      { matriz: ['2', '4', '6', '8', '10', '12', '14', '16', '❓'], resposta: '18', opcoes: ['19', '20', '16', '18'], dica: 'Olhe UMA linha por vez: da esquerda para a direita, some sempre o mesmo número.' },
      { matriz: ['5', '10', '15', '20', '25', '30', '35', '40', '❓'], resposta: '45', opcoes: ['46', '50', '40', '45'], dica: 'Olhe UMA linha por vez: da esquerda para a direita, some sempre o mesmo número.' },
      { matriz: ['10', '20', '30', '40', '50', '60', '70', '80', '❓'], resposta: '90', opcoes: ['80', '100', '91', '90'], dica: 'Olhe UMA linha por vez: da esquerda para a direita, some sempre o mesmo número.' },
      { matriz: ['3', '6', '9', '12', '15', '18', '21', '24', '❓'], resposta: '27', opcoes: ['24', '30', '28', '27'], dica: 'Olhe UMA linha por vez: da esquerda para a direita, some sempre o mesmo número.' },
    ],
  },
  {
    id: 'con_padrao_soma_coluna',
    tipo: 'padrao',
    titulo: 'A Terceira é a Soma',
    ...
    coins_reward: 90,
    tempo_estimado: 8,
    historinha: 'Duas contas e um resultado: a terceira coluna é a soma das duas primeiras! 🟰 Complete.',
    puzzles: [
      { matriz: ['2', '3', '5', '4', '5', '9', '6', '7', '❓'], resposta: '13', opcoes: ['12', '14', '15', '13'], dica: 'Some os DOIS primeiros números da linha: o resultado é o terceiro.' },
      { matriz: ['10', '5', '15', '20', '7', '27', '30', '9', '❓'], resposta: '39', opcoes: ['35', '43', '40', '39'], dica: 'Some os DOIS primeiros números da linha: o resultado é o terceiro.' },
      { matriz: ['1', '9', '10', '2', '8', '10', '3', '7', '❓'], resposta: '10', opcoes: ['9', '11', '12', '10'], dica: 'Some os DOIS primeiros números da linha: o resultado é o terceiro.' },
      { matriz: ['12', '12', '24', '15', '15', '30', '18', '18', '❓'], resposta: '36', opcoes: ['32', '40', '37', '36'], dica: 'Some os DOIS primeiros números da linha: o resultado é o terceiro.' },
      { matriz: ['25', '25', '50', '30', '20', '50', '40', '15', '❓'], resposta: '55', opcoes: ['49', '61', '56', '55'], dica: 'Some os DOIS primeiros números da linha: o resultado é o terceiro.' },
    ],
  },
  {
    id: 'con_padrao_diferenca',
    tipo: 'padrao',
    titulo: 'A Terceira é a Diferença',
    descricao: 'A terceira coluna é a subtração das outras duas.',
    emoji: '➖',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 8,
    historinha: 'Agora é o contrário: a terceira coluna é o que sobra depois de tirar. ➖ Complete a matriz.',
    puzzles: [
      { matriz: ['9', '2', '7', '8', '3', '5', '7', '4', '❓'], resposta: '3', opcoes: ['2', '4', '5', '3'], dica: 'Subtraia o SEGUNDO número do primeiro: o resultado é o terceiro.' },
      { matriz: ['20', '5', '15', '30', '10', '20', '40', '15', '❓'], resposta: '25', opcoes: ['28', '22', '26', '25'], dica: 'Subtraia o SEGUNDO número do primeiro: o resultado é o terceiro.' },
      { matriz: ['15', '7', '8', '18', '9', '9', '21', '11', '❓'], resposta: '10', opcoes: ['11', '9', '12', '10'], dica: 'Subtraia o SEGUNDO número do primeiro: o resultado é o terceiro.' },
      { matriz: ['100', '40', '60', '90', '30', '60', '80', '20', '❓'], resposta: '60', opcoes: ['66', '54', '61', '60'], dica: 'Subtraia o SEGUNDO número do primeiro: o resultado é o terceiro.' },
      { matriz: ['50', '25', '25', '45', '20', '25', '35', '10', '❓'], resposta: '25', opcoes: ['28', '22', '26', '25'], dica: 'Subtraia o SEGUNDO número do primeiro: o resultado é o terceiro.' },
    ],
  },
  {
    id: 'con_padrao_produto',
    tipo: 'padrao',
    titulo: 'A Terceira é o Produto',
    descricao: 'A terceira coluna é a multiplicação das outras duas.',
    emoji: '✖️',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 8,
    historinha: 'Tabuada escondida numa matriz! ✖️ A terceira coluna é o produto das duas primeiras.',
    puzzles: [
      { matriz: ['2', '3', '6', '3', '4', '12', '4', '5', '❓'], resposta: '20', opcoes: ['22', '18', '21', '20'], dica: 'Multiplique os DOIS primeiros números da linha.' },
      { matriz: ['2', '5', '10', '3', '5', '15', '4', '5', '❓'], resposta: '20', opcoes: ['22', '18', '21', '20'], dica: 'Multiplique os DOIS primeiros números da linha.' },
      { matriz: ['6', '2', '12', '7', '2', '14', '8', '2', '❓'], resposta: '16', opcoes: ['18', '14', '17', '16'], dica: 'Multiplique os DOIS primeiros números da linha.' },
      { matriz: ['3', '3', '9', '4', '4', '16', '5', '5', '❓'], resposta: '25', opcoes: ['28', '22', '26', '25'], dica: 'Multiplique os DOIS primeiros números da linha.' },
      { matriz: ['10', '3', '30', '10', '6', '60', '10', '9', '❓'], resposta: '90', opcoes: ['81', '91', '99', '90'], dica: 'Multiplique os DOIS primeiros números da linha.' },
    ],
  },
  {
    id: 'con_padrao_letras',
    tipo: 'padrao',
    titulo: 'Fileiras de Letras',
    descricao: 'Cada fileira tem as mesmas letras!',
    emoji: '🔤',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 90,
    coins_reward: 90,
    tempo_estimado: 8,
    historinha: 'As letras foram arrumadas em fileiras, cada uma com as mesmas três! 🔤 Qual falta?',
    puzzles: [
      { matriz: ['A', 'B', 'C', 'B', 'C', 'A', 'C', 'A', '❓'], resposta: 'B', opcoes: ['B', 'R', 'C', 'A'], dica: 'Em cada linha aparecem as MESMAS 3 letras, em ordem diferente.' },
      { matriz: ['X', 'Y', 'Z', 'Z', 'X', 'Y', 'Y', 'Z', '❓'], resposta: 'X', opcoes: ['Q', 'Y', 'Z', 'X'], dica: 'Em cada linha aparecem as MESMAS 3 letras, em ordem diferente.' },
      { matriz: ['M', 'N', 'O', 'N', 'O', 'M', 'O', 'M', '❓'], resposta: 'N', opcoes: ['M', 'G', 'O', 'N'], dica: 'Em cada linha aparecem as MESMAS 3 letras, em ordem diferente.' },
      { matriz: ['P', 'Q', 'R', 'R', 'P', 'Q', 'Q', 'R', '❓'], resposta: 'P', opcoes: ['Q', 'P', 'O', 'R'], dica: 'Em cada linha aparecem as MESMAS 3 letras, em ordem diferente.' },
      { matriz: ['D', 'E', 'F', 'E', 'F', 'D', 'F', 'D', '❓'], resposta: 'E', opcoes: ['E', 'D', 'H', 'F'], dica: 'Em cada linha aparecem as MESMAS 3 letras, em ordem diferente.' },
    ],
  },
]
