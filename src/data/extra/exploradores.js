...
export const atividadesExtraPorFaixa = [
  ...
  // ── lote 14/09/2026: memória de 5 para 20 nesta faixa ────────────────
  {
    id: 'exp_memoria_filhotes',
    tipo: 'memoria',
    titulo: 'Filhotes',
    descricao: 'Combine os pares de filhotes!',
    emoji: '🐣',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Todo bicho grande já foi pequenininho! 🐣 Encontre os pares de filhotes e descubra o nome de cada um.',
    pares: [
      { emoji: '🐣', nome: 'Pintinho', info: 'Filhote da galinha' },
      { emoji: '🐶', nome: 'Cachorrinho', info: 'Filhote do cachorro' },
      { emoji: '🐱', nome: 'Gatinho', info: 'Filhote do gato' },
      { emoji: '🐑', nome: 'Cordeirinho', info: 'Filhote da ovelha' },
      { emoji: '🐴', nome: 'Potrinho', info: 'Filhote do cavalo' },
      { emoji: '🐸', nome: 'Girino', info: 'Filhote do sapo, nasce na água' },
      { emoji: '🦆', nome: 'Patinho', info: 'Filhote do pato' },
      { emoji: '🐝', nome: 'Larvinha', info: 'Filhote da abelha, fica no favo' },
    ],
  },
  {
    id: 'exp_memoria_instrumentos',
    tipo: 'memoria',
    titulo: 'Instrumentos Musicais',
    descricao: 'Combine os pares de instrumentos!',
    emoji: '🥁',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'A banda vai tocar! 🥁 Cada instrumento faz um som diferente. Encontre os pares e ouça a música na sua cabeça.',
    pares: [
      { emoji: '🥁', nome: 'Tambor', info: 'Faz um som grave: tum tum!' },
      { emoji: '🎸', nome: 'Violão', info: 'Tem seis cordas para dedilhar' },
      { emoji: '🎹', nome: 'Piano', info: 'Tem teclas pretas e brancas' },
      { emoji: '🎺', nome: 'Trompete', info: 'Som forte e brilhante' },
      { emoji: '🎻', nome: 'Violino', info: 'Toca com um arco' },
      { emoji: '🪇', nome: 'Chocalho', info: 'Faz barulho quando balança' },
      { emoji: '🪈', nome: 'Flauta', info: 'Sopra e sai um som fininho' },
      { emoji: '🎷', nome: 'Saxofone', info: 'Som macio, de música lenta' },
    ],
  },
  {
    id: 'exp_memoria_roupas',
    tipo: 'memoria',
    titulo: 'Roupas do Dia',
    descricao: 'Combine os pares de roupas!',
    emoji: '👕',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Hora de se arrumar! 👕 Cada roupa serve para uma parte do corpo. Encontre os pares e monte o seu visual.',
    pares: [
      { emoji: '👕', nome: 'Camiseta', info: 'Veste o tronco e os braços' },
      { emoji: '👖', nome: 'Calça', info: 'Veste as duas pernas' },
      { emoji: '🧦', nome: 'Meia', info: 'Vai dentro do sapato' },
      { emoji: '👟', nome: 'Tênis', info: 'Protege o pé para correr' },
      { emoji: '🧢', nome: 'Boné', info: 'Protege o rosto do sol' },
      { emoji: '🧥', nome: 'Casaco', info: 'Serve para os dias frios' },
      { emoji: '🧤', nome: 'Luva', info: 'Esquenta as mãos' },
      { emoji: '🩳', nome: 'Bermuda', info: 'Boa para o dia quente' },
    ],
  },
  {
    id: 'exp_memoria_brinquedos',
    tipo: 'memoria',
    titulo: 'Caixa de Brinquedos',
    descricao: 'Combine os pares de brinquedos!',
    emoji: '🧸',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'A caixa de brinquedos virou de cabeça para baixo! 🧸 Encontre os pares e guarde tudo de volta.',
    pares: [
      { emoji: '🧸', nome: 'Ursinho', info: 'Bom para abraçar' },
      { emoji: '⚽', nome: 'Bola', info: 'Rola e quica no chão' },
      { emoji: '🪁', nome: 'Pipa', info: 'Voa com o vento' },
      { emoji: '🧩', nome: 'Quebra-cabeça', info: 'Junta peça por peça' },
      { emoji: '🪀', nome: 'Ioiô', info: 'Sobe e desce no barbante' },
      { emoji: '🚗', nome: 'Carrinho', info: 'Anda sobre quatro rodinhas' },
      { emoji: '🎈', nome: 'Balão', info: 'Cheio de ar, fica leve' },
      { emoji: '🪆', nome: 'Boneca', info: 'Cabe uma dentro da outra' },
    ],
  },
  {
    id: 'exp_memoria_banho',
    tipo: 'memoria',
    titulo: 'Hora do Banho',
    descricao: 'Combine os pares do banheiro!',
    emoji: '🧼',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Splash! 🧼 A hora do banho tem cheirinho bom. Encontre os pares e veja para que serve cada coisa.',
    pares: [
      { emoji: '🧼', nome: 'Sabonete', info: 'Faz espuma e tira a sujeira' },
      { emoji: '🪥', nome: 'Escova de dente', info: 'Limpa os dentinhos' },
      { emoji: '🛁', nome: 'Banheira', info: 'Cheia de água morna' },
      { emoji: '🚿', nome: 'Chuveiro', info: 'A água cai de cima' },
      { emoji: '🧴', nome: 'Xampu', info: 'Lava o cabelo' },
      { emoji: '🧽', nome: 'Esponja', info: 'Ensaboa o corpo' },
      { emoji: '🪒', nome: 'Pente', info: 'Arruma o cabelo molhado' },
      { emoji: '🦆', nome: 'Patinho', info: 'O brinquedo que boia' },
    ],
  },
  {
    id: 'exp_memoria_cafe_manha',
    tipo: 'memoria',
    titulo: 'Café da Manhã',
    descricao: 'Combine os pares do café da manhã!',
    emoji: '🥞',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Bom dia! 🥞 A mesa está posta e tem coisa gostosa. Encontre os pares antes da barriga roncar.',
    pares: [
      { emoji: '🥞', nome: 'Panqueca', info: 'Fica fofinha na frigideira' },
      { emoji: '🥛', nome: 'Leite', info: 'Ajuda os ossos a crescer' },
      { emoji: '🍞', nome: 'Pão', info: 'Fica quentinho na torradeira' },
      { emoji: '🧈', nome: 'Manteiga', info: 'Derrete no pão quente' },
      { emoji: '🍌', nome: 'Banana', info: 'Dá energia para brincar' },
      { emoji: '🥣', nome: 'Cereal', info: 'Faz crec-crec no leite' },
      { emoji: '🍯', nome: 'Mel', info: 'Doce, feito pelas abelhas' },
      { emoji: '🧃', nome: 'Suco', info: 'Feito de fruta espremida' },
    ],
  },
  {
    id: 'exp_memoria_clima',
    tipo: 'memoria',
    titulo: 'Tempo e Clima',
    descricao: 'Combine os pares do tempo!',
    emoji: '☀️',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Como está o tempo hoje? ☀️ Olhe pela janela e encontre os pares do céu.',
    pares: [
      { emoji: '☀️', nome: 'Sol', info: 'Dia claro e quentinho' },
      { emoji: '🌧️', nome: 'Chuva', info: 'A água cai das nuvens' },
      { emoji: '☁️', nome: 'Nuvem', info: 'Algodão branco no céu' },
      { emoji: '🌈', nome: 'Arco-íris', info: 'Aparece depois da chuva' },
      { emoji: '❄️', nome: 'Neve', info: 'Água congelada que cai' },
      { emoji: '🌬️', nome: 'Vento', info: 'Não se vê, mas mexe as folhas' },
      { emoji: '⛈️', nome: 'Trovão', info: 'Faz barulho depois do raio' },
      { emoji: '🌫️', nome: 'Neblina', info: 'Nuvem baixinha, perto do chão' },
    ],
  },
  {
    id: 'exp_memoria_casa',
    tipo: 'memoria',
    titulo: 'Cômodos da Casa',
    descricao: 'Combine os pares da casa!',
    emoji: '🏠',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Cada cantinho da casa serve para uma coisa! 🏠 Encontre os pares e passeie por todos eles.',
    pares: [
      { emoji: '🛏️', nome: 'Quarto', info: 'Lugar de dormir' },
      { emoji: '🍽️', nome: 'Cozinha', info: 'Onde a comida é feita' },
      { emoji: '🛋️', nome: 'Sala', info: 'Lugar de ficar junto' },
      { emoji: '🚪', nome: 'Porta', info: 'Por onde se entra e sai' },
      { emoji: '🪟', nome: 'Janela', info: 'Deixa a luz entrar' },
      { emoji: '🪜', nome: 'Escada', info: 'Leva para o andar de cima' },
      { emoji: '🌱', nome: 'Quintal', info: 'Espaço para brincar fora' },
      { emoji: '🧹', nome: 'Vassoura', info: 'Junta a sujeira do chão' },
    ],
  },
  {
    id: 'exp_memoria_jardim',
    tipo: 'memoria',
    titulo: 'Bichinhos do Jardim',
    descricao: 'Combine os pares do jardim!',
    emoji: '🐞',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'No jardim mora muita gente pequena! 🐞 Abaixe e olhe de perto: encontre os pares.',
    pares: [
      { emoji: '🐞', nome: 'Joaninha', info: 'Vermelha com pintinhas pretas' },
      { emoji: '🐜', nome: 'Formiga', info: 'Carrega folha maior que ela' },
      { emoji: '🦋', nome: 'Borboleta', info: 'Antes era lagarta' },
      { emoji: '🐌', nome: 'Caracol', info: 'Leva a casinha nas costas' },
      { emoji: '🐝', nome: 'Abelha', info: 'Faz mel e ajuda as flores' },
      { emoji: '🕷️', nome: 'Aranha', info: 'Tece teia para pegar insetos' },
      { emoji: '🪱', nome: 'Minhoca', info: 'Cava a terra e deixa ela fofa' },
      { emoji: '🦗', nome: 'Grilo', info: 'Canta cri-cri à noite' },
    ],
  },
  {
    id: 'exp_memoria_mar',
    tipo: 'memoria',
    titulo: 'Bichos do Mar',
    descricao: 'Combine os pares do fundo do mar!',
    emoji: '🐙',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Vamos mergulhar! 🐙 O mar é cheio de bichos coloridos. Encontre os pares antes do ar acabar.',
    pares: [
      { emoji: '🐙', nome: 'Polvo', info: 'Tem oito braços' },
      { emoji: '🐢', nome: 'Tartaruga', info: 'Nada devagar e vive muito' },
      { emoji: '🦀', nome: 'Caranguejo', info: 'Anda de lado' },
      { emoji: '🐠', nome: 'Peixinho', info: 'Nada em cardume' },
      { emoji: '🐬', nome: 'Golfinho', info: 'Muito esperto e brincalhão' },
      { emoji: '🦑', nome: 'Lula', info: 'Solta tinta para fugir' },
      { emoji: '🐳', nome: 'Baleia', info: 'O maior animal do mundo' },
      { emoji: '⭐', nome: 'Estrela-do-mar', info: 'Tem cinco braços' },
    ],
  },
  {
    id: 'exp_memoria_esportes',
    tipo: 'memoria',
    titulo: 'Vamos Brincar!',
    descricao: 'Combine os pares de esportes!',
    emoji: '🏀',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Bora mexer o corpo! 🏀 Cada esporte tem um jeito de jogar. Encontre os pares e escolha o seu.',
    pares: [
      { emoji: '⚽', nome: 'Futebol', info: 'Chuta a bola com o pé' },
      { emoji: '🏀', nome: 'Basquete', info: 'Joga a bola na cesta alta' },
      { emoji: '🏊', nome: 'Natação', info: 'Nada de um lado ao outro' },
      { emoji: '🚴', nome: 'Ciclismo', info: 'Pedala a bicicleta' },
      { emoji: '🤸', nome: 'Ginástica', info: 'Dá cambalhota e salta' },
      { emoji: '🏐', nome: 'Vôlei', info: 'A bola não pode cair' },
      { emoji: '🏓', nome: 'Tênis de mesa', info: 'Bolinha leve e raquete pequena' },
      { emoji: '🥋', nome: 'Judô', info: 'Aprende a cair sem se machucar' },
    ],
  },
  {
    id: 'exp_memoria_aves',
    tipo: 'memoria',
    titulo: 'Passarinhos',
    descricao: 'Combine os pares de passarinhos!',
    emoji: '🦜',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Escute! 🦜 Cada passarinho tem um canto diferente. Encontre os pares e conheça cada um.',
    pares: [
      { emoji: '🦜', nome: 'Papagaio', info: 'Repete o que a gente fala' },
      { emoji: '🦉', nome: 'Coruja', info: 'Enxerga bem à noite' },
      { emoji: '🐦', nome: 'Sabiá', info: 'Canta bem de manhãzinha' },
      { emoji: '🦩', nome: 'Flamingo', info: 'Fica em pé numa perna só' },
      { emoji: '🦚', nome: 'Pavão', info: 'Abre um leque de penas' },
      { emoji: '🐧', nome: 'Pinguim', info: 'Nada mas não voa' },
      { emoji: '🦅', nome: 'Águia', info: 'Enxerga de muito longe' },
      { emoji: '🕊️', nome: 'Pomba', info: 'Símbolo da paz' },
    ],
  },
  {
    id: 'exp_memoria_legumes',
    tipo: 'memoria',
    titulo: 'Verduras e Legumes',
    descricao: 'Combine os pares da horta!',
    emoji: '🥕',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'A horta está cheia! 🥕 Tem coisa que cresce embaixo da terra e coisa que cresce em cima. Encontre os pares.',
    pares: [
      { emoji: '🥕', nome: 'Cenoura', info: 'Cresce embaixo da terra' },
      { emoji: '🥦', nome: 'Brócolis', info: 'Parece uma arvorezinha' },
      { emoji: '🍅', nome: 'Tomate', info: 'Vermelho e sumarento' },
      { emoji: '🥬', nome: 'Alface', info: 'Folha verde da salada' },
      { emoji: '🌽', nome: 'Milho', info: 'Tem grãos amarelos na espiga' },
      { emoji: '🥒', nome: 'Pepino', info: 'Verde, comprido e crocante' },
      { emoji: '🧅', nome: 'Cebola', info: 'Faz os olhos lacrimejarem' },
      { emoji: '🥔', nome: 'Batata', info: 'Cresce na terra, vira purê' },
    ],
  },
  {
    id: 'exp_memoria_festa',
    tipo: 'memoria',
    titulo: 'Festa de Aniversário',
    descricao: 'Combine os pares da festa!',
    emoji: '🎂',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Parabéns pra você! 🎂 A festa está pronta. Encontre os pares antes de cantar.',
    pares: [
      { emoji: '🎂', nome: 'Bolo', info: 'Tem velinha em cima' },
      { emoji: '🎈', nome: 'Balão', info: 'Enche de ar e flutua' },
      { emoji: '🎁', nome: 'Presente', info: 'Embrulhado, com surpresa dentro' },
      { emoji: '🎉', nome: 'Confete', info: 'Papelzinho colorido que voa' },
      { emoji: '🍬', nome: 'Doce', info: 'Vem no saquinho da lembrança' },
      { emoji: '🕯️', nome: 'Velinha', info: 'Se apaga com um sopro' },
      { emoji: '🎵', nome: 'Música', info: 'Todo mundo canta junto' },
      { emoji: '🤡', nome: 'Palhaço', info: 'Faz todo mundo rir' },
    ],
  },
  {
    id: 'exp_memoria_veiculos',
    tipo: 'memoria',
    titulo: 'Quem Leva a Gente',
    descricao: 'Combine os pares de veículos!',
    emoji: '🚌',
    habilidade: 'Memória Visual',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Vrum! 🚌 Cada veículo anda num lugar: na rua, no trilho, na água ou no céu. Encontre os pares.',
    pares: [
      { emoji: '🚌', nome: 'Ônibus', info: 'Leva muita gente junto' },
      { emoji: '🚲', nome: 'Bicicleta', info: 'Anda com força das pernas' },
      { emoji: '🚑', nome: 'Ambulância', info: 'Corre para socorrer' },
      { emoji: '🚜', nome: 'Trator', info: 'Trabalha na roça' },
      { emoji: '⛵', nome: 'Barco', info: 'Anda em cima da água' },
      { emoji: '🚁', nome: 'Helicóptero', info: 'Sobe com a hélice girando' },
      { emoji: '🛵', nome: 'Moto', info: 'Rápida e com duas rodas' },
      { emoji: '🚕', nome: 'Táxi', info: 'Leva onde a gente pedir' },
    ],
  },
]
...
export const colorirExtraPorFaixa = [
  ...
  // ── lote 15/09/2026: colorir de 7 para 20 em exploradores ────────────
  {
    id: 'exp_colorir_peixe',
    tipo: 'colorir',
    ...
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Um peixinho passeando no fundo do mar! 🐟 Escolha as cores e deixe ele bem bonito.',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Peixe',
        regioes: [
          { id: 'corpo', tipo: 'path', props: { d: 'M 70 150 C 70 106 114 86 164 86 C 214 86 250 114 250 150 C 250 186 214 214 164 214 C 114 214 70 194 70 150 Z', bbox: [180, 128] } },
          { id: 'cauda', tipo: 'polygon', props: { points: '72,150 22,100 22,200', bbox: [50, 100] } },
          { id: 'barbatana_cima', tipo: 'polygon', props: { points: '140,88 168,38 198,90', bbox: [58, 52] } },
          { id: 'barbatana_baixo', tipo: 'polygon', props: { points: '140,212 168,262 198,210', bbox: [58, 52] } },
          { id: 'olho', tipo: 'circle', decorativo: true, props: { cx: 212, cy: 132, r: 11, bbox: [22, 22] } },
          { id: 'bolha', tipo: 'circle', decorativo: true, props: { cx: 268, cy: 78, r: 13, bbox: [26, 26] } },
        ],
      },
    },
  },
  {
    id: 'exp_colorir_borboleta',
    tipo: 'colorir',
    ...
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'A borboleta abriu as asas para você pintar! 🦋 Cada asa pode ter uma cor diferente.',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Borboleta',
        regioes: [
          { id: 'asa_cima_esq', tipo: 'path', props: { d: 'M 142 140 C 100 60 40 52 30 92 C 20 132 70 152 142 150 Z', bbox: [113.2, 81.6] } },
          { id: 'asa_cima_dir', tipo: 'path', props: { d: 'M 158 140 C 200 60 260 52 270 92 C 280 132 230 152 158 150 Z', bbox: [113.2, 81.6] } },
          { id: 'asa_baixo_esq', tipo: 'path', props: { d: 'M 142 156 C 104 210 56 248 42 216 C 28 184 78 164 142 162 Z', bbox: [102.3, 71.7] } },
          { id: 'asa_baixo_dir', tipo: 'path', props: { d: 'M 158 156 C 196 210 244 248 258 216 C 272 184 222 164 158 162 Z', bbox: [102.3, 71.7] } },
          { id: 'corpo', tipo: 'rect', decorativo: true, props: { x: 142, y: 82, width: 16, height: 150, rx: 8, bbox: [16, 150] } },
          { id: 'antena_esq', tipo: 'path', decorativo: true, props: { d: 'M 146 84 C 132 62 118 56 110 58', bbox: [36, 26.4] } },
          { id: 'antena_dir', tipo: 'path', decorativo: true, props: { d: 'M 154 84 C 168 62 182 56 190 58', bbox: [36, 26.4] } },
        ],
      },
    },
  },
  {
    id: 'exp_colorir_arvore',
    tipo: 'colorir',
    ...
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Uma árvore grande no meio do campo! 🌳 Pinte a copa, o tronco e as frutinhas.',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Árvore',
        regioes: [
          { id: 'copa', tipo: 'circle', props: { cx: 150, cy: 104, r: 86, bbox: [172, 172] } },
          { id: 'tronco', tipo: 'rect', props: { x: 128, y: 178, width: 44, height: 92, rx: 6, bbox: [44, 92] } },
          { id: 'grama', tipo: 'ellipse', props: { cx: 150, cy: 272, rx: 116, ry: 24, bbox: [232, 48] } },
          { id: 'fruta_esq', tipo: 'circle', props: { cx: 108, cy: 96, r: 17, bbox: [34, 34] } },
          { id: 'fruta_dir', tipo: 'circle', props: { cx: 192, cy: 126, r: 17, bbox: [34, 34] } },
        ],
      },
    },
  },
  {
    id: 'exp_colorir_carrinho',
    tipo: 'colorir',
    titulo: 'Colorir: Carrinho',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '🚗',
    habilidade: 'Criatividade',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Vrum! 🚗 Um carrinho pronto para a corrida. De que cor ele vai ficar?',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Carrinho',
        regioes: [
          { id: 'carroceria', tipo: 'path', props: { d: 'M 28 196 C 28 168 42 158 66 156 L 92 122 C 100 112 112 108 126 108 L 202 108 C 218 108 230 114 238 126 L 260 158 C 274 162 282 172 282 196 C 282 208 274 214 262 214 L 48 214 C 36 214 28 208 28 196 Z', bbox: [254, 106] } },
          { id: 'janela_esq', tipo: 'polygon', props: { points: '106,150 132,118 150,118 150,150', bbox: [44, 32] } },
          { id: 'janela_dir', tipo: 'polygon', props: { points: '162,118 200,118 224,150 162,150', bbox: [62, 32] } },
          { id: 'roda_esq', tipo: 'circle', props: { cx: 88, cy: 218, r: 34, bbox: [68, 68] } },
          { id: 'roda_dir', tipo: 'circle', props: { cx: 222, cy: 218, r: 34, bbox: [68, 68] } },
          { id: 'farol', tipo: 'circle', decorativo: true, props: { cx: 272, cy: 182, r: 10, bbox: [20, 20] } },
        ],
      },
    },
  },
  {
    id: 'exp_colorir_barquinho',
    tipo: 'colorir',
    titulo: 'Colorir: Barquinho',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '⛵',
    habilidade: 'Criatividade',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'O barquinho vai navegar! ⛵ Pinte as velas, o casco e o mar.',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Barquinho',
        regioes: [
          { id: 'vela_grande', tipo: 'polygon', props: { points: '150,30 150,176 44,176', bbox: [106, 146] } },
          { id: 'vela_pequena', tipo: 'polygon', props: { points: '164,58 246,176 164,176', bbox: [82, 118] } },
          { id: 'casco', tipo: 'path', props: { d: 'M 30 186 L 270 186 L 236 240 C 230 250 220 254 206 254 L 94 254 C 80 254 70 250 64 240 Z', bbox: [240, 68] } },
          { id: 'mar', tipo: 'path', props: { d: 'M 10 262 C 50 250 76 274 116 262 C 156 250 182 274 222 262 C 252 253 272 266 292 262 L 292 292 L 10 292 Z', bbox: [282, 33.4] } },
          { id: 'mastro', tipo: 'rect', decorativo: true, props: { x: 152, y: 28, width: 10, height: 156, rx: 4, bbox: [10, 156] } },
        ],
      },
    },
  },
  {
    id: 'exp_colorir_patinho',
    tipo: 'colorir',
    titulo: 'Colorir: Patinho',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '🦆',
    habilidade: 'Criatividade',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Quá-quá! 🦆 O patinho está nadando na lagoa. Escolha as cores dele.',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Patinho',
        regioes: [
          { id: 'corpo', tipo: 'path', props: { d: 'M 60 206 C 60 158 104 132 156 132 C 214 132 252 160 252 200 C 252 224 232 240 198 240 L 106 240 C 76 240 60 226 60 206 Z', bbox: [192, 108] } },
          { id: 'cabeca', tipo: 'circle', props: { cx: 214, cy: 106, r: 48, bbox: [96, 96] } },
          { id: 'asa', tipo: 'path', props: { d: 'M 96 180 C 112 152 150 146 176 164 C 198 180 190 212 160 216 C 126 220 100 206 96 180 Z', bbox: [92.5, 62.9] } },
          { id: 'agua', tipo: 'ellipse', props: { cx: 150, cy: 254, rx: 130, ry: 26, bbox: [260, 52] } },
          { id: 'bico', tipo: 'polygon', decorativo: true, props: { points: '256,100 296,112 256,124', bbox: [40, 24] } },
          { id: 'olho', tipo: 'circle', decorativo: true, props: { cx: 226, cy: 92, r: 8, bbox: [16, 16] } },
        ],
      },
    },
  },
  {
    id: 'exp_colorir_coelho',
    tipo: 'colorir',
    titulo: 'Colorir: Coelho',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '🐰',
    habilidade: 'Criatividade',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Um coelhinho de orelhas compridas! 🐰 Pinte do jeito que você quiser.',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Coelho',
        regioes: [
          { id: 'corpo', tipo: 'ellipse', props: { cx: 150, cy: 216, rx: 76, ry: 62, bbox: [152, 124] } },
          { id: 'cabeca', tipo: 'circle', props: { cx: 150, cy: 134, r: 54, bbox: [108, 108] } },
          { id: 'orelha_esq', tipo: 'ellipse', props: { cx: 122, cy: 56, rx: 20, ry: 50, bbox: [40, 100] } },
          { id: 'orelha_dir', tipo: 'ellipse', props: { cx: 178, cy: 56, rx: 20, ry: 50, bbox: [40, 100] } },
          { id: 'rabo', tipo: 'circle', props: { cx: 236, cy: 236, r: 22, bbox: [44, 44] } },
          { id: 'olho_esq', tipo: 'circle', decorativo: true, props: { cx: 132, cy: 128, r: 7, bbox: [14, 14] } },
          { id: 'olho_dir', tipo: 'circle', decorativo: true, props: { cx: 168, cy: 128, r: 7, bbox: [14, 14] } },
          { id: 'focinho', tipo: 'polygon', decorativo: true, props: { points: '150,146 142,156 158,156', bbox: [16, 10] } },
        ],
      },
    },
  },
  {
    id: 'exp_colorir_noite',
    tipo: 'colorir',
    titulo: 'Colorir: Céu de Estrelas',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '⭐',
    habilidade: 'Criatividade',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'A noite chegou e o céu está cheio de estrelas! ⭐ Pinte a lua e as estrelinhas.',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Céu de Estrelas',
        regioes: [
          { id: 'lua', tipo: 'path', props: { d: 'M 196 44 C 148 44 110 82 110 130 C 110 178 148 216 196 216 C 172 196 158 166 158 130 C 158 94 172 64 196 44 Z', bbox: [86, 172] } },
          { id: 'estrela_grande', tipo: 'polygon', props: { points: '78,52 92,96 138,96 100,122 114,166 78,140 42,166 56,122 18,96 64,96', bbox: [120, 114] } },
          { id: 'estrela_media', tipo: 'polygon', props: { points: '232,216 242,246 274,246 248,264 258,294 232,276 206,294 216,264 190,246 222,246', bbox: [84, 78] } },
          { id: 'estrela_pequena', tipo: 'polygon', props: { points: '92,214 100,238 126,238 105,253 113,277 92,262 71,277 79,253 58,238 84,238', bbox: [68, 63] } },
        ],
      },
    },
  },
  {
    id: 'exp_colorir_guarda_chuva',
    tipo: 'colorir',
    titulo: 'Colorir: Guarda-chuva',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '☂️',
    habilidade: 'Criatividade',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Vai chover! ☂️ Pinte o guarda-chuva com as cores que você mais gosta.',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Guarda-chuva',
        regioes: [
          { id: 'gomo_esq', tipo: 'path', props: { d: 'M 24 160 C 24 100 72 56 118 50 C 100 84 94 122 96 160 Z', bbox: [94, 110] } },
          { id: 'gomo_meio', tipo: 'path', props: { d: 'M 100 160 C 98 120 108 82 130 48 L 170 48 C 192 82 202 120 200 160 Z', bbox: [100.5, 112] } },
          { id: 'gomo_dir', tipo: 'path', props: { d: 'M 204 160 C 206 122 200 84 182 50 C 228 56 276 100 276 160 Z', bbox: [94, 110] } },
          { id: 'poca', tipo: 'ellipse', props: { cx: 150, cy: 276, rx: 104, ry: 20, bbox: [208, 40] } },
          { id: 'cabo', tipo: 'path', decorativo: true, props: { d: 'M 144 160 L 156 160 L 156 232 C 156 244 166 250 176 246 L 180 257 C 162 265 144 254 144 234 Z', bbox: [36, 97] } },
          { id: 'gota_esq', tipo: 'ellipse', decorativo: true, props: { cx: 52, cy: 206, rx: 9, ry: 14, bbox: [18, 28] } },
          { id: 'gota_dir', tipo: 'ellipse', decorativo: true, props: { cx: 250, cy: 214, rx: 9, ry: 14, bbox: [18, 28] } },
        ],
      },
    },
  },
  {
    id: 'exp_colorir_macas',
    tipo: 'colorir',
    titulo: 'Colorir: Maçãs no Prato',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '🍎',
    habilidade: 'Criatividade',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Duas maçãs bem redondas num prato! 🍎 Pinte cada uma de um jeito.',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Maçãs no Prato',
        regioes: [
          { id: 'maca_esq', tipo: 'path', props: { d: 'M 106 96 C 138 82 160 102 160 134 C 160 178 136 214 106 214 C 76 214 52 178 52 134 C 52 102 74 82 106 96 Z', bbox: [108, 122.5] } },
          { id: 'maca_dir', tipo: 'path', props: { d: 'M 196 110 C 224 98 244 116 244 144 C 244 182 223 214 196 214 C 169 214 148 182 148 144 C 148 116 168 98 196 110 Z', bbox: [96, 107.7] } },
          { id: 'folha', tipo: 'path', props: { d: 'M 112 88 C 134 56 172 52 186 66 C 166 96 134 100 112 88 Z', bbox: [74, 35.9] } },
          { id: 'prato', tipo: 'ellipse', props: { cx: 150, cy: 236, rx: 126, ry: 30, bbox: [252, 60] } },
          { id: 'cabinho', tipo: 'path', decorativo: true, props: { d: 'M 106 94 C 104 78 106 66 112 58', bbox: [6.8, 36] } },
        ],
      },
    },
  },
  {
    id: 'exp_colorir_chuva',
    tipo: 'colorir',
    titulo: 'Colorir: Nuvem de Chuva',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '🌧️',
    habilidade: 'Criatividade',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'A nuvem trouxe chuvinha! 🌧️ Pinte a nuvem e as gotas que estão caindo.',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Nuvem de Chuva',
        regioes: [
          { id: 'nuvem', tipo: 'path', props: { d: 'M 58 166 C 30 166 16 148 20 126 C 24 106 42 96 62 100 C 66 66 96 44 130 48 C 160 52 180 72 186 98 C 214 90 244 106 250 134 C 256 160 238 168 216 168 Z', bbox: [231.8, 120.4] } },
          { id: 'gota_esq', tipo: 'path', props: { d: 'M 84 194 C 100 214 106 228 98 240 C 90 252 72 250 68 238 C 64 224 72 210 84 194 Z', bbox: [34.6, 54] } },
          { id: 'gota_meio', tipo: 'path', props: { d: 'M 150 206 C 166 226 172 240 164 252 C 156 264 138 262 134 250 C 130 236 138 222 150 206 Z', bbox: [34.6, 54] } },
          { id: 'gota_dir', tipo: 'path', props: { d: 'M 216 194 C 232 214 238 228 230 240 C 222 252 204 250 200 238 C 196 224 204 210 216 194 Z', bbox: [34.6, 54] } },
        ],
      },
    },
  },
  {
    ...
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'A pipa está bem lá em cima! 🪁 Cada pedaço pode ter uma cor diferente.',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Pipa',
        regioes: [
          { id: 'pedaco_cima', tipo: 'polygon', props: { points: '150,20 250,120 150,120', bbox: [100, 100] } },
          { id: 'pedaco_esq', tipo: 'polygon', props: { points: '150,20 50,120 150,120', bbox: [100, 100] } },
          { id: 'pedaco_baixo_esq', tipo: 'polygon', props: { points: '50,120 150,120 150,232', bbox: [100, 112] } },
          { id: 'pedaco_baixo_dir', tipo: 'polygon', props: { points: '250,120 150,232 150,120', bbox: [100, 112] } },
          { id: 'rabiola', tipo: 'path', decorativo: true, props: { d: 'M 150 234 C 138 252 162 262 150 280', bbox: [6.9, 46] } },
        ],
      },
    },
  },
  {
    id: 'exp_colorir_tartaruga',
    tipo: 'colorir',
    titulo: 'Colorir: Tartaruga',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '🐢',
    habilidade: 'Criatividade',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 6,
    historinha: 'Devagar e sempre! 🐢 Pinte o casco da tartaruga com muitas cores.',
    dados: {
      desenho: {
        viewBox: 300,
        nome: 'Tartaruga',
        regioes: [
          { id: 'casco', tipo: 'path', props: { d: 'M 62 190 C 62 132 102 94 152 94 C 202 94 240 132 240 190 Z', bbox: [178, 96] } },
          { id: 'barriga', tipo: 'path', props: { d: 'M 62 192 L 240 192 C 240 212 224 222 200 222 L 100 222 C 76 222 62 212 62 192 Z', bbox: [178, 30] } },
          { id: 'cabeca', tipo: 'path', props: { d: 'M 242 168 C 262 158 288 166 290 186 C 292 206 270 216 250 208 C 240 204 238 182 242 168 Z', bbox: [50, 47] } },
          { id: 'pata_esq', tipo: 'ellipse', props: { cx: 88, cy: 232, rx: 30, ry: 18, bbox: [60, 36] } },
          { id: 'pata_dir', tipo: 'ellipse', props: { cx: 206, cy: 232, rx: 30, ry: 18, bbox: [60, 36] } },
          { id: 'olho', tipo: 'circle', decorativo: true, props: { cx: 268, cy: 180, r: 7, bbox: [14, 14] } },
        ],
      },
    },
  },
...
{
    id: 'exp_colorir_coelho2',
    tipo: 'colorir',
    titulo: 'Colorir: Coelhinho',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '🎨',
    habilidade: 'Criatividade',
    xp_reward: 60,
...
{
    id: 'exp_colorir_coruja',
    tipo: 'colorir',
    titulo: 'Colorir: Coruja',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '🎨',
    habilidade: 'Criatividade',
    xp_reward: 60,
...
{
    id: 'exp_colorir_fantasma',
    tipo: 'colorir',
    titulo: 'Colorir: Fantasminha',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '🎨',
    habilidade: 'Criatividade',
    xp_reward: 60,
...
{
    id: 'exp_colorir_flor_feliz',
    tipo: 'colorir',
    titulo: 'Colorir: Flor Feliz',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '🎨',
    habilidade: 'Criatividade',
    xp_reward: 60,
  ...
  },
{
    id: 'exp_colorir_maca',
    tipo: 'colorir',
    titulo: 'Colorir: Maçã Sorridente',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '🎨',
    habilidade: 'Criatividade',
    xp_reward: 60,
...
{
    id: 'exp_colorir_tartaruga2',
    tipo: 'colorir',
    titulo: 'Colorir: Tartaruguinha',
    descricao: 'Pinte o desenho do jeito que você quiser!',
    emoji: '🎨',
    habilidade: 'Criatividade',
    xp_reward: 60,
...
export const fase2ExtraPorFaixa = [
  ...
  // ── lote 14/09/2026: labirinto de 5 para 20 nesta faixa ──────────────
  {
    id: 'exp_labirinto_jardim',
    tipo: 'labirinto',
    titulo: 'Jardim das Borboletas',
    descricao: 'Ache o caminho até a flor maior!',
    emoji: '🦋',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'As borboletas estão te esperando na flor maior do jardim! 🦋 Siga o caminho entre as plantinhas e chegue até elas.',
    tamanho: 5,
  },
  {
    id: 'exp_labirinto_brinquedos',
    tipo: 'labirinto',
    titulo: 'Caixa de Brinquedos',
    descricao: 'Seu ursinho se perdeu na caixa!',
    emoji: '🧸',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'Seu ursinho se escondeu no fundo da caixa de brinquedos! 🧸 Passe entre os blocos e os carrinhos para encontrar ele.',
    tamanho: 5,
  },
  {
    id: 'exp_labirinto_padaria',
    tipo: 'labirinto',
    titulo: 'Padaria do Vovô',
    descricao: 'O cheirinho vem do forno. Siga ele!',
    emoji: '🥐',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'Hummm, que cheiro bom! 🥐 O vovô acabou de tirar o pãozinho do forno. Siga o cheirinho até a cozinha!',
    tamanho: 5,
  },
  {
    id: 'exp_labirinto_praia',
    tipo: 'labirinto',
    titulo: 'Praia da Estrela',
    descricao: 'Encontre a estrela-do-mar na areia!',
    emoji: '🏖️',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'Uma estrelinha do mar ficou presa na areia! ⭐ Ande pela praia com cuidado e leve ela de volta para a água.',
    tamanho: 5,
  },
  {
    id: 'exp_labirinto_zoo',
    tipo: 'labirinto',
    titulo: 'Zoológico Amigo',
    descricao: 'Visite o leãozinho no final!',
    emoji: '🦁',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'O leãozinho está esperando visita! 🦁 Passe pelo caminho do zoológico e vá dar um oi para ele.',
    tamanho: 5,
  },
  {
    id: 'exp_labirinto_circo',
    tipo: 'labirinto',
    titulo: 'Circo das Luzes',
    descricao: 'Chegue ao picadeiro antes do show!',
    emoji: '🎪',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'O show vai começar! 🎪 Corra pelo corredor do circo e sente na primeira fila antes das luzes acenderem.',
    tamanho: 5,
  },
  {
    id: 'exp_labirinto_neve',
    tipo: 'labirinto',
    titulo: 'Montanha de Neve',
    descricao: 'Leve o cachecol para o boneco!',
    emoji: '⛄',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'O boneco de neve está com frio no pescoço! ⛄ Leve o cachecol vermelho até ele pelo caminho da montanha.',
    tamanho: 5,
  },
  {
    id: 'exp_labirinto_arco_iris',
    tipo: 'labirinto',
    titulo: 'Caminho do Arco-Íris',
    descricao: 'Siga as cores até o final!',
    emoji: '🌈',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'Depois da chuva nasceu um arco-íris! 🌈 Caminhe por baixo dele e descubra o que tem do outro lado.',
    tamanho: 5,
  },
  {
    id: 'exp_labirinto_formiga',
    tipo: 'labirinto',
    titulo: 'Formigueiro',
    descricao: 'Ajude a formiguinha a voltar pra casa!',
    emoji: '🐜',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'A formiguinha carregou uma folha tão grande que se perdeu! 🐜 Leve ela de volta para o formigueiro.',
    tamanho: 7,
  },
  {
    id: 'exp_labirinto_doces',
    tipo: 'labirinto',
    titulo: 'Vila dos Doces',
    descricao: 'Ache a casinha de chocolate!',
    emoji: '🍭',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'Tudo aqui é doce: o chão é de biscoito e as árvores são pirulitos! 🍭 Ache a casinha de chocolate no fim do caminho.',
    tamanho: 7,
  },
  {
    id: 'exp_labirinto_trem',
    tipo: 'labirinto',
    titulo: 'Estação do Trem',
    descricao: 'Chegue na plataforma a tempo!',
    emoji: '🚂',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'O trenzinho apita: piuí! 🚂 Corra pelos corredores da estação e chegue na plataforma antes dele partir.',
    tamanho: 7,
  },
  {
    id: 'exp_labirinto_pomar',
    tipo: 'labirinto',
    titulo: 'Pomar das Frutas',
    descricao: 'Encontre a macieira mais bonita!',
    emoji: '🍎',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'No pomar tem laranja, uva e banana! 🍎 Mas a macieira mais bonita está lá no fundo. Vamos achar ela?',
    tamanho: 7,
  },
  {
    id: 'exp_labirinto_lua',
    tipo: 'labirinto',
    titulo: 'Passeio na Lua',
    descricao: 'Volte para o foguete!',
    emoji: '🌙',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'Você pulou tão alto na Lua que se afastou do foguete! 🌙 Volte pulando pelas crateras até a nave.',
    tamanho: 7,
  },
  {
    id: 'exp_labirinto_aquario',
    tipo: 'labirinto',
    titulo: 'Aquário Azul',
    descricao: 'Siga o peixinho laranja!',
    emoji: '🐠',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'O peixinho laranja conhece o aquário inteiro! 🐠 Nade atrás dele por entre os corais até a janelinha grande.',
    tamanho: 7,
  },
  {
    id: 'exp_labirinto_parque',
    tipo: 'labirinto',
    titulo: 'Parque da Pracinha',
    descricao: 'Chegue no escorregador!',
    emoji: '🛝',
    habilidade: 'Raciocínio Espacial',
    xp_reward: 60,
    coins_reward: 60,
    tempo_estimado: 5,
    historinha: 'A pracinha está cheia de gente hoje! 🛝 Passe pelo balanço e pela gangorra e chegue no escorregador.',
    tamanho: 7,
  },
]
...
export const quizExtraPorFaixa = [
  ...
  // ── lote 15/09/2026: quiz de 15 para 20 nesta faixa ──────────────────
  {
    id: 'exp_quiz_familia',
    tipo: 'quiz',
    titulo: 'Minha Família',
    descricao: 'Quem é quem na família?',
    emoji: '👨‍👩‍👧',
    habilidade: 'Conhecimento Geral',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 6,
    historinha: 'Toda família é diferente, e todas são família! 👨‍👩‍👧 Vamos ver se você sabe quem é quem.',
    perguntas: [
      {
        pergunta: 'Quem é a mãe da sua mãe?',
        opcoes: ['A avó', 'A tia', 'A prima', 'A irmã'],
        correta: 0,
        fato: '👵 A mãe da sua mãe (ou do seu pai) é a sua avó. Você é neto ou neta dela!',
      },
      {
        pergunta: 'O filho do seu tio é seu...',
        opcoes: ['Primo', 'Irmão', 'Avô', 'Sobrinho'],
        correta: 0,
        fato: '🧒 Filho de tio é primo! Primos costumam ter idades parecidas e viram grandes amigos.',
      },
      {
        pergunta: 'Quem nasceu dos mesmos pais que você é seu...',
        opcoes: ['Irmão', 'Vizinho', 'Colega', 'Tio'],
        correta: 0,
        fato: '👫 Irmãos têm os mesmos pais. Gêmeos nasceram no mesmo dia!',
      },
      {
        pergunta: 'O que toda família precisa ter?',
        opcoes: ['Cuidado e carinho', 'Um carro', 'Uma piscina', 'Muitos brinquedos'],
        correta: 0,
        fato: '❤️ Família não se mede por tamanho nem por coisas: o que faz uma família é o cuidado.',
      },
      {
        pergunta: 'Quantos pais e mães uma família pode ter?',
        opcoes: ['Pode variar', 'Sempre dois', 'Sempre um', 'Sempre três'],
        correta: 0,
        fato: '🏠 Tem família com pai e mãe, com duas mães, com dois pais, com avós criando... todas valem.',
      },
    ],
  },
  {
    id: 'exp_quiz_natureza',
    tipo: 'quiz',
    titulo: 'Lá Fora na Natureza',
    descricao: 'O que tem no mundo lá fora?',
    emoji: '🌳',
    habilidade: 'Conhecimento Geral',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 6,
    historinha: 'A natureza está cheia de coisas para descobrir! 🌳 Vamos ver o que você já sabe.',
    perguntas: [
      {
        pergunta: 'De onde as plantas tiram energia?',
        opcoes: ['Do sol', 'Da televisão', 'Do vento', 'Da areia'],
        correta: 0,
        fato: '☀️ As plantas usam a luz do sol para fazer comida. Isso se chama fotossíntese!',
      },
      {
        pergunta: 'O que a chuva faz pelas plantas?',
        opcoes: ['Dá água para elas', 'Deixa elas com frio', 'Tira a cor delas', 'Não faz nada'],
        correta: 0,
        fato: '🌧️ Sem água a planta murcha. A chuva é a rega que a natureza faz sozinha!',
      },
      {
        pergunta: 'Onde a minhoca gosta de morar?',
        opcoes: ['Na terra', 'No céu', 'No fogo', 'Na geladeira'],
        correta: 0,
        fato: '🪱 A minhoca cava a terra e deixa ela fofinha — isso ajuda as plantas a crescer!',
      },
      {
        pergunta: 'O que sai do vulcão?',
        opcoes: ['Lava quente', 'Sorvete', 'Água gelada', 'Papel'],
        correta: 0,
        fato: '🌋 Lava é rocha derretida, tão quente que brilha! Quando esfria, vira pedra dura.',
      },
      {
        pergunta: 'Por que as árvores são importantes?',
        opcoes: ['Limpam o ar', 'Fazem barulho', 'Deixam tudo escuro', 'Comem insetos'],
        correta: 0,
        fato: '🌳 Árvores tiram gás carbônico do ar e devolvem oxigênio — o que a gente respira!',
      },
    ],
  },
  {
    id: 'exp_quiz_seguranca',
    tipo: 'quiz',
    titulo: 'Me Cuidando',
    descricao: 'Como ficar seguro no dia a dia!',
    emoji: '🦺',
    habilidade: 'Conhecimento Geral',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 6,
    historinha: 'Saber se cuidar é coisa de gente grande — e você já pode aprender! 🦺 Vamos lá?',
    perguntas: [
      {
        pergunta: 'Antes de atravessar a rua você deve...',
        opcoes: ['Olhar dos dois lados', 'Correr rápido', 'Fechar os olhos', 'Pular'],
        correta: 0,
        fato: '🚦 Olhe para a esquerda, para a direita e de novo para a esquerda. E dê a mão a um adulto!',
      },
      {
        pergunta: 'No carro, criança viaja...',
        opcoes: ['Na cadeirinha', 'No colo', 'Em pé', 'No porta-malas'],
        correta: 0,
        fato: '🚗 A cadeirinha é feita para o tamanho da criança e segura o corpo no lugar certo.',
      },
      {
        pergunta: 'Se você se perder num lugar cheio, procure...',
        opcoes: ['Um funcionário do lugar', 'Qualquer estranho', 'Ninguém', 'A saída sozinho'],
        correta: 0,
        fato: '🦺 Procure alguém uniformizado ou um adulto com criança, e fique parado onde está.',
      },
      {
        pergunta: 'Pode mexer em tomada?',
        opcoes: ['Não, nunca', 'Só com o dedo', 'Só com garfo', 'Sim, sempre'],
        correta: 0,
        fato: '⚡ Tomada dá choque. Se quiser ligar algo, peça a um adulto.',
      },
      {
        pergunta: 'Remédio só pode ser tomado...',
        opcoes: ['Com um adulto', 'Quando der vontade', 'Escondido', 'Se for colorido'],
        correta: 0,
        fato: '💊 Remédio não é bala! Só um adulto responsável pode dar, na dose certa.',
      },
    ],
  },
  {
    id: 'exp_quiz_brincadeiras',
    tipo: 'quiz',
    titulo: 'Hora de Brincar',
    descricao: 'Brincadeiras e como elas funcionam!',
    emoji: '🎠',
    habilidade: 'Conhecimento Geral',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 6,
    historinha: 'Brincar é o trabalho mais sério da infância! 🎠 Vamos ver quanto você sabe de brincadeira.',
    perguntas: [
      {
        pergunta: 'No esconde-esconde, quem conta fica de olhos...',
        opcoes: ['Fechados', 'Abertos', 'Pintados', 'Vendados com mel'],
        correta: 0,
        fato: '🙈 Quem conta fecha os olhos para não ver onde os outros se escondem. Sem espiar!',
      },
      {
        pergunta: 'O que faz a pipa subir?',
        opcoes: ['O vento', 'A chuva', 'O barulho', 'A terra'],
        correta: 0,
        fato: '🪁 O vento empurra a pipa para cima. Sem vento, ela não sai do chão!',
      },
      {
        pergunta: 'Na amarelinha você pula...',
        opcoes: ['Nos quadradinhos', 'Na parede', 'No telhado', 'Na água'],
        correta: 0,
        fato: '🔢 A amarelinha tem números no chão. Você pula num pé só, sem pisar na linha!',
      },
      {
        pergunta: 'O cabo de guerra se ganha...',
        opcoes: ['Puxando junto', 'Gritando', 'Correndo', 'Soltando a corda'],
        correta: 0,
        fato: '🪢 Quando o time puxa tudo ao mesmo tempo, a força soma. Trabalho em equipe!',
      },
      {
        pergunta: 'Brincar com os amigos ajuda a...',
        opcoes: ['Aprender a dividir', 'Ficar bravo', 'Dormir menos', 'Falar sozinho'],
        correta: 0,
        fato: '🤝 Brincando junto a gente aprende a esperar a vez, dividir e resolver briguinha.',
      },
    ],
  },
  {
    id: 'exp_quiz_cores_mundo',
    tipo: 'quiz',
    titulo: 'Cores no Mundo',
    descricao: 'Onde estão as cores?',
    emoji: '🎨',
    habilidade: 'Conhecimento Geral',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 6,
    historinha: 'O mundo é colorido do jeito dele! 🎨 Vamos descobrir de que cor são as coisas.',
    perguntas: [
      {
        pergunta: 'De que cor fica o céu num dia de sol?',
        opcoes: ['Azul', 'Roxo', 'Marrom', 'Preto'],
        correta: 0,
        fato: '🌤️ O céu é azul porque a luz azul do sol se espalha mais no ar do que as outras cores.',
      },
      {
        pergunta: 'Que cor a gente vê na grama?',
        opcoes: ['Verde', 'Vermelho', 'Rosa', 'Cinza'],
        correta: 0,
        fato: '🌱 A grama é verde por causa da clorofila, a substância que ajuda a planta a comer luz.',
      },
      {
        pergunta: 'Misturando azul e amarelo dá...',
        opcoes: ['Verde', 'Roxo', 'Preto', 'Branco'],
        correta: 0,
        fato: '🎨 Azul + amarelo = verde! Experimente com tinta e veja acontecer.',
      },
      {
        pergunta: 'Qual cor aparece no céu depois da chuva, em arco?',
        opcoes: ['Todas do arco-íris', 'Só o preto', 'Só o cinza', 'Nenhuma'],
        correta: 0,
        fato: '🌈 A gota de chuva separa a luz branca do sol em várias cores. Isso é o arco-íris!',
      },
      {
        pergunta: 'De que cor fica a banana quando amadurece?',
        opcoes: ['Amarela', 'Azul', 'Roxa', 'Cinza'],
        correta: 0,
        fato: '🍌 A banana começa verde e vai ficando amarela conforme amadurece e fica docinha.',
      },
    ],
  },
]
...
export const raciocinioExtraPorFaixa = [
  ...
  // ── lote 15/09/2026: sequência e padrão a 20 por faixa ───────────────
  {
    id: 'exp_seq_zoologico',
    tipo: 'sequencia',
    titulo: 'Fila do Zoológico',
    descricao: 'Os bichos entram sempre na mesma ordem. Quem vem agora?',
    emoji: '🦒',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 7,
    historinha: 'Os bichos do zoológico entram na fila do banho sempre na mesma ordem! 🦒 Olhe com atenção e diga quem é o próximo.',
    sequencias: [
      { items: ['🦒', '🐘', '🦒', '🐘', '❓'], resposta: '🦒', opcoes: ['🦒', '🦌', '🐻', '🐘'] },
      { items: ['🦁', '🐯', '🐻', '🦁', '🐯', '🐻', '❓'], resposta: '🦁', opcoes: ['🦁', '🦩', '🐯', '🐻'] },
      { items: ['🐵', '🦓', '🐵', '🦓', '🐵', '🦓', '❓'], resposta: '🐵', opcoes: ['🐯', '🦩', '🐵', '🦓'] },
  ...
  },
  {
    id: 'exp_seq_bandeja',
    tipo: 'sequencia',
    titulo: 'Bandeja de Doces',
    descricao: 'Os doces foram arrumados numa ordem. Qual falta?',
    emoji: '🍬',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 7,
    historinha: 'A vovó arrumou a bandeja de doces numa ordem bem caprichada! 🍬 Um doce sumiu do fim da fila. Qual era?',
    sequencias: [
      { items: ['🍬', '🍭', '🍬', '🍭', '🍬', '🍭', '❓'], resposta: '🍬', opcoes: ['🍡', '🍬', '🍭', '🍨'] },
      { items: ['🍫', '🍪', '🧁', '🍫', '🍪', '🧁', '❓'], resposta: '🍫', opcoes: ['🧁', '🍪', '🍫', '🍬'] },
      { items: ['🍩', '🥧', '🍩', '🥧', '🍩', '❓'], resposta: '🥧', opcoes: ['🍩', '🍰', '🥧', '🧁'] },
  ...
  },
  {
    ...
    descricao: 'Os veículos passam sempre na mesma ordem!',
    emoji: '🚗',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 7,
    historinha: 'Da janela dá para ver a rua inteira! 🚗 Os veículos passam sempre repetindo a mesma ordem. Qual vem agora?',
    sequencias: [
      { items: ['🚗', '🚌', '🚗', '🚌', '🚗', '❓'], resposta: '🚌', opcoes: ['🚌', '🚗', '🚚', '🚲'] },
      { items: ['🚲', '🛵', '🚕', '🚲', '🛵', '🚕', '❓'], resposta: '🚲', opcoes: ['🚲', '🚕', '🛵', '🏍️'] },
      { items: ['🚑', '🚒', '🚑', '🚒', '🚑', '🚒', '❓'], resposta: '🚑', opcoes: ['✈️', '🚒', '🚑', '🛵'] },
  ...
  },
  {
    id: 'exp_seq_canteiro',
    tipo: 'sequencia',
    titulo: 'Canteiro de Flores',
    descricao: 'As flores foram plantadas seguindo um padrão.',
    emoji: '🌷',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 7,
    historinha: 'No canteiro, cada flor foi plantada seguindo um padrão de cores! 🌷 Complete o canteiro com a flor certa.',
    sequencias: [
      { items: ['🌷', '🌻', '🌷', '🌻', '❓'], resposta: '🌷', opcoes: ['🍀', '🌻', '🌺', '🌷'] },
      { items: ['🌹', '🌼', '🌺', '🌹', '🌼', '🌺', '❓'], resposta: '🌹', opcoes: ['🌼', '🌺', '🌵', '🌹'] },
      { items: ['🌸', '💐', '🌸', '💐', '🌸', '💐', '❓'], resposta: '🌸', opcoes: ['🌼', '🪴', '🌸', '💐'] },
  ...
  {
    id: 'exp_seq_brincadeira',
    tipo: 'sequencia',
    titulo: 'Roda de Brincadeira',
    descricao: 'As brincadeiras se repetem na mesma ordem!',
    emoji: '🎠',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 7,
    historinha: 'Na roda, cada criança escolhe uma brincadeira e a ordem se repete! 🎠 Qual brincadeira vem agora?',
    sequencias: [
      { items: ['⚽', '🪁', '⚽', '🪁', '⚽', '🪁', '❓'], resposta: '⚽', opcoes: ['🤸', '⚽', '🎪', '🪁'] },
      { items: ['🎨', '🧩', '🎲', '🎨', '🧩', '🎲', '❓'], resposta: '🎨', opcoes: ['🎲', '⚽', '🧩', '🎨'] },
      { items: ['🪀', '🎈', '🪀', '🎈', '🪀', '❓'], resposta: '🎈', opcoes: ['🎺', '🎨', '🎈', '🪀'] },
  ...
  {
    id: 'exp_padrao_transportes',
    tipo: 'padrao',
    titulo: 'Garagem Organizada',
    descricao: 'Cada fileira tem os mesmos veículos!',
    emoji: '🚗',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 7,
    historinha: 'Na garagem, cada fileira tem os mesmos três veículos, só que em ordem diferente! 🚗 Qual falta?',
    puzzles: [
      { matriz: ['🚗', '🚌', '🚲', '🚌', '🚲', '🚗', '🚲', '🚗', '❓'], resposta: '🚌', opcoes: ['🚑', '🚌', '🚗', '🚲'], dica: 'Em cada linha aparecem os MESMOS 3 veículos, em ordem diferente.' },
      { matriz: ['🚑', '🚒', '🚕', '🚕', '🚑', '🚒', '🚒', '🚕', '❓'], resposta: '🚑', opcoes: ['🚜', '🚒', '🚕', '🚑'], dica: 'Em cada linha aparecem os MESMOS 3 veículos, em ordem diferente.' },
      { matriz: ['✈️', '⛵', '🚂', '⛵', '🚂', '✈️', '🚂', '✈️', '❓'], resposta: '⛵', opcoes: ['⛵', '✈️', '🚚', '🚂'], dica: 'Em cada linha aparecem os MESMOS 3 veículos, em ordem diferente.' },
      { matriz: ['🛵', '🚚', '🚜', '🚜', '🛵', '🚚', '🚚', '🚜', '❓'], resposta: '🛵', opcoes: ['🛵', '🚚', '🏍️', '🚜'], dica: 'Em cada linha aparecem os MESMOS 3 veículos, em ordem diferente.' },
      { matriz: ['🚁', '🛴', '🏍️', '🛴', '🏍️', '🚁', '🏍️', '🚁', '❓'], resposta: '🛴', opcoes: ['🚁', '🏍️', '🚲', '🛴'], dica: 'Em cada linha aparecem os MESMOS 3 veículos, em ordem diferente.' },
    ],
  },
  {
    id: 'exp_padrao_mar',
    tipo: 'padrao',
    titulo: 'Aquário Arrumado',
    descricao: 'Cada fileira tem os mesmos bichos do mar!',
    emoji: '🐙',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 7,
    historinha: 'No aquário, cada prateleira tem os mesmos três bichinhos em ordens diferentes! 🐙 Quem falta?',
    puzzles: [
      { matriz: ['🐙', '🐠', '🦀', '🐠', '🦀', '🐙', '🦀', '🐙', '❓'], resposta: '🐠', opcoes: ['🐠', '🦀', '🐡', '🐙'], dica: 'Em cada linha aparecem os MESMOS 3 bichos, em ordem diferente.' },
      { matriz: ['🐬', '🐢', '🦈', '🦈', '🐬', '🐢', '🐢', '🦈', '❓'], resposta: '🐬', opcoes: ['🐬', '🦈', '🐢', '🐚'], dica: 'Em cada linha aparecem os MESMOS 3 bichos, em ordem diferente.' },
      { matriz: ['🐳', '🦑', '⭐', '🦑', '⭐', '🐳', '⭐', '🐳', '❓'], resposta: '🦑', opcoes: ['🐳', '⭐', '🦑', '🦈'], dica: 'Em cada linha aparecem os MESMOS 3 bichos, em ordem diferente.' },
      { matriz: ['🦐', '🐡', '🐚', '🐚', '🦐', '🐡', '🐡', '🐚', '❓'], resposta: '🦐', opcoes: ['🐳', '🐚', '🦐', '🐡'], dica: 'Em cada linha aparecem os MESMOS 3 bichos, em ordem diferente.' },
      { matriz: ['🪸', '🐋', '🦞', '🐋', '🦞', '🪸', '🦞', '🪸', '❓'], resposta: '🐋', opcoes: ['🦞', '🪸', '🐋', '🐳'], dica: 'Em cada linha aparecem os MESMOS 3 bichos, em ordem diferente.' },
  ...
  {
    id: 'exp_padrao_natureza',
    tipo: 'padrao',
    titulo: 'Quintal da Vovó',
    descricao: 'Cada fileira tem as mesmas plantinhas!',
    emoji: '🌳',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 7,
    historinha: 'A vovó plantou tudo em fileiras bem certinhas! 🌳 Complete o canteiro que ficou faltando.',
    puzzles: [
      { matriz: ['🌳', '🌻', '🍀', '🌻', '🍀', '🌳', '🍀', '🌳', '❓'], resposta: '🌻', opcoes: ['🍀', '🍂', '🌻', '🌳'], dica: 'Em cada linha aparecem as MESMAS 3 plantas, em ordem diferente.' },
      { matriz: ['🌵', '🌷', '🌿', '🌿', '🌵', '🌷', '🌷', '🌿', '❓'], resposta: '🌵', opcoes: ['🌿', '🌵', '🍄', '🌷'], dica: 'Em cada linha aparecem as MESMAS 3 plantas, em ordem diferente.' },
      { matriz: ['🍄', '🌱', '🌸', '🌱', '🌸', '🍄', '🌸', '🍄', '❓'], resposta: '🌱', opcoes: ['🌸', '🌱', '🍄', '🍀'], dica: 'Em cada linha aparecem as MESMAS 3 plantas, em ordem diferente.' },
      { matriz: ['🌴', '🪴', '🌾', '🌾', '🌴', '🪴', '🪴', '🌾', '❓'], resposta: '🌴', opcoes: ['🌻', '🌴', '🌾', '🪴'], dica: 'Em cada linha aparecem as MESMAS 3 plantas, em ordem diferente.' },
      { matriz: ['🍁', '🍂', '🌺', '🍂', '🌺', '🍁', '🌺', '🍁', '❓'], resposta: '🍂', opcoes: ['🍁', '🍂', '🌺', '🍀'], dica: 'Em cada linha aparecem as MESMAS 3 plantas, em ordem diferente.' },
  ...
  {
    id: 'exp_padrao_musica',
    tipo: 'padrao',
    titulo: 'Banda Organizada',
    descricao: 'Cada fileira tem os mesmos instrumentos!',
    emoji: '🎵',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 7,
    historinha: 'A banda se arruma em três fileiras, cada uma com os mesmos instrumentos! 🎵 Qual falta?',
    puzzles: [
      { matriz: ['🥁', '🎸', '🎺', '🎸', '🎺', '🥁', '🎺', '🥁', '❓'], resposta: '🎸', opcoes: ['🎺', '🎸', '🥁', '🪈'], dica: 'Em cada linha aparecem os MESMOS 3 instrumentos, em ordem diferente.' },
      { matriz: ['🎹', '🎻', '🪇', '🪇', '🎹', '🎻', '🎻', '🪇', '❓'], resposta: '🎹', opcoes: ['🎷', '🎹', '🪇', '🎻'], dica: 'Em cada linha aparecem os MESMOS 3 instrumentos, em ordem diferente.' },
      { matriz: ['🎤', '🪈', '🎷', '🪈', '🎷', '🎤', '🎷', '🎤', '❓'], resposta: '🪈', opcoes: ['🪈', '🎤', '🎷', '🎼'], dica: 'Em cada linha aparecem os MESMOS 3 instrumentos, em ordem diferente.' },
      { matriz: ['🔔', '📯', '🎼', '🎼', '🔔', '📯', '📯', '🎼', '❓'], resposta: '🔔', opcoes: ['🔔', '🪇', '🎼', '📯'], dica: 'Em cada linha aparecem os MESMOS 3 instrumentos, em ordem diferente.' },
      { matriz: ['🪘', '🎧', '📻', '🎧', '📻', '🪘', '📻', '🪘', '❓'], resposta: '🎧', opcoes: ['📯', '📻', '🎧', '🪘'], dica: 'Em cada linha aparecem os MESMOS 3 instrumentos, em ordem diferente.' },
  ...
  },
  {
    ...
    tipo: 'padrao',
    titulo: 'Confeitaria',
    descricao: 'Cada bandeja tem os mesmos doces!',
    emoji: '🍭',
    habilidade: 'Reconhecimento de Padrões',
    xp_reward: 70,
    coins_reward: 70,
    tempo_estimado: 7,
    historinha: 'Na confeitaria, cada bandeja leva os mesmos três doces em ordem diferente! 🍭 Qual sumiu?',
    puzzles: [
      { matriz: ['🍭', '🍫', '🍩', '🍫', '🍩', '🍭', '🍩', '🍭', '❓'], resposta: '🍫', opcoes: ['🍫', '🍭', '🍩', '🍮'], dica: 'Em cada linha aparecem os MESMOS 3 doces, em ordem diferente.' },
      { matriz: ['🧁', '🍪', '🥧', '🥧', '🧁', '🍪', '🍪', '🥧', '❓'], resposta: '🧁', opcoes: ['🍪', '🍡', '🧁', '🥧'], dica: 'Em cada linha aparecem os MESMOS 3 doces, em ordem diferente.' },
      { matriz: ['🍮', '🍰', '🍬', '🍰', '🍬', '🍮', '🍬', '🍮', '❓'], resposta: '🍰', opcoes: ['🍭', '🍮', '🍬', '🍰'], dica: 'Em cada linha aparecem os MESMOS 3 doces, em ordem diferente.' },
      { matriz: ['🍦', '🍧', '🍨', '🍨', '🍦', '🍧', '🍧', '🍨', '❓'], resposta: '🍦', opcoes: ['🍯', '🍧', '🍨', '🍦'], dica: 'Em cada linha aparecem os MESMOS 3 doces, em ordem diferente.' },
      { matriz: ['🍯', '🥮', '🍡', '🥮', '🍡', '🍯', '🍡', '🍯', '❓'], resposta: '🥮', opcoes: ['🥮', '🍯', '🍰', '🍡'], dica: 'Em cada linha aparecem os MESMOS 3 doces, em ordem diferente.' },
