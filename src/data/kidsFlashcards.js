// Flashcards de estudo por categoria Kids TV
// Cada card: { frente, verso, emoji, dica }
...
export const kidsFlashcards = {
  ...
  corpo_humano: [
    { emoji: '❤️', frente: 'Quantas vezes o coração bate por dia?', verso: 'Cerca de 100.000 vezes por dia! Em 70 anos de vida, isso dá aproximadamente 2,5 bilhões de batimentos.', dica: 'Nunca para para descanso!' },
    { emoji: '🧠', frente: 'Quantos neurônios tem o cérebro humano?', verso: '86 bilhões de neurônios! Cada um conectado a até 10.000 outros, formando 100 trilhões de sinapses.', dica: 'Mais conexões que estrelas na galáxia' },
  ...
  animais: [
    { emoji: '🐘', frente: 'Qual é a gestação do elefante africano?', verso: '22 meses! É a gestação mais longa de qualquer animal terrestre. O filhote nasce com 120 kg e já fica em pé em horas.', dica: 'Quase 2 anos!' },
  ...
  esportes: [
    { emoji: '🏃', frente: 'Qual é o recorde mundial dos 100 metros rasos?', verso: '9,58 segundos por Usain Bolt (Jamaica, 2009). Velocidade média de 37,6 km/h — mais rápido que a maioria dos carros em cidade!', dica: 'Trovoada = 9,58s nos 100m' },
    { emoji: '🧠', frente: 'O que acontece no cérebro durante o exercício?', verso: 'Libera endorfinas (bem-estar), BDNF (cria neurônios novos!), serotonina (humor) e dopamina (motivação). Exercício é o melhor antidepressivo natural!', dica: '30min = neurônios novos' },
    { emoji: '💪', frente: 'Como o treino faz o músculo crescer?', verso: 'Treino cria microfissuras nas fibras musculares. Durante o repouso, o corpo as repara maiores e mais fortes — supercompensação. Sem descanso, não há crescimento!', dica: 'Crescer = descanso + proteína' },
    { emoji: '⚽', frente: 'Em qual país o futebol é o esporte mais popular e qual o maior campeão mundial?', verso: 'Futebol é o mais popular no mundo inteiro! E o Brasil é o maior campeão da Copa do Mundo: 5 títulos (1958, 62, 70, 94, 2002).', dica: 'Pentacampeão!' },
    { emoji: '🏊', frente: 'Por que nadadores raspam o corpo?', verso: 'A pelagem cria arrasto hidrodinâmico. Raspando, o atleta fica 1-2% mais rápido — o suficiente para quebrar recordes. Também melhora a percepção tátil da água.', dica: 'Milésimos de segundo importam!' },
    { emoji: '🎯', frente: 'O que é a Zone (ou estado de fluxo)?', verso: 'Estado psicológico de concentração total onde atletas executam no limite máximo sem esforço consciente. Cérebro ativo, crítica interna silenciada.', dica: 'Todo atleta de elite busca isso' },
  ],

  coracao: [
    { emoji: '💓', frente: 'Quais são as 4 câmaras do coração?', verso: 'Átrio direito, ventrículo direito, átrio esquerdo e ventrículo esquerdo. Átrios recebem o sangue; ventrículos o bombeiam para fora.', dica: 'Dois átrios, dois ventrículos' },
    { emoji: '🩺', frente: 'O que mede o eletrocardiograma (ECG)?', verso: 'Os impulsos elétricos que controlam os batimentos. O coração tem seu próprio marcapasso natural (nó sinoatrial) que gera esses impulsos ritmicamente.', dica: 'O coração é autoelétrico!' },
    { emoji: '🩸', frente: 'Qual a diferença entre sangue arterial e venoso?', verso: 'Arterial: rico em oxigênio, cor vermelho-vivo, vai do coração para o corpo. Venoso: pobre em oxigênio, mais escuro, volta para o coração e pulmões.', dica: 'Artéria = sai, veia = volta' },
    { emoji: '❤️', frente: 'Qual é o BPM (batimentos por minuto) normal de adulto em repouso?', verso: 'Entre 60 e 100 BPM. Atletas de endurance podem ter 40 BPM — o coração ficou tão forte que bombeia mais sangue em cada batimento.', dica: 'Menos batidas = coração mais forte' },
    { emoji: '🏥', frente: 'O que é infarto do miocárdio?', verso: 'Quando uma artéria coronária (que alimenta o próprio coração de sangue) é bloqueada. Parte do músculo cardíaco fica sem oxigênio e morre. É emergência!', dica: 'Coração sem sangue = coração infartando' },
  ],

  golfinhos: [
    { emoji: '🐬', frente: 'Golfinhos respiram pela boca ou nariz?', verso: 'Pelo espiráculo, um "nariz" no topo da cabeça. Precisam vir à superfície a cada 7-15 minutos para respirar — são mamíferos, não peixes!', dica: 'Pulmão, não brânquia!' },
    { emoji: '🔊', frente: 'Como funciona a ecolocalização dos golfinhos?', verso: 'Emitem cliques de até 200.000 Hz pelo melão (testa). O eco retorna e o cérebro cria um mapa 3D do ambiente. Precisão de milímetros a dezenas de metros.', dica: 'Sonar biológico mais preciso que radar' },
    { emoji: '😴', frente: 'Como golfinhos dormem sem se afogar?', verso: 'Sono unihemisférico: dormem com metade do cérebro de cada vez! Um lado descansa enquanto o outro mantém o nadar automático e a respiração consciente.', dica: 'Literalmente dormem com um olho aberto' },
    { emoji: '🧠', frente: 'Qual o QI estimado de um golfinho comparado a animais?', verso: 'Golfinhos têm encéfalo proporcional ao corpo similar ao humano. São considerados o 2° animal mais inteligente depois de primatas, com reconhecimento de espelho e ferramentas.', dica: 'Reconhecem o próprio reflexo!' },
    { emoji: '🤝', frente: 'O que é o comportamento altruísta observado em golfinhos?', verso: 'Ajudam animais feridos, dão à luz apoiados por outras fêmeas ("comadres"), e já salvaram humanos de tubarões — sem ganho evolutivo direto para si.', dica: 'Altruísmo era tido como humano exclusivo' },
  ],

  vulcoes: [
    { emoji: '🌋', frente: 'O que é magma? E lava?', verso: 'Magma é rocha derretida DENTRO da Terra. Quando sai para a superfície por uma erupção, passa a se chamar lava. Mesma coisa, lugar diferente!', dica: 'Magma → lava ao sair' },
    { emoji: '🏔️', frente: 'Qual é o vulcão mais alto do mundo?', verso: 'Ojos del Salado, nos Andes (Chile/Argentina), com 6.893 metros! O Mauna Kea no Havaí é o maior se medido do fundo do oceano: 10.210 metros no total.', dica: 'Depende de onde você mede' },
    { emoji: '💨', frente: 'O que causou o "Ano sem Verão" em 1816?', verso: 'A erupção do vulcão Tambora (Indonésia, 1815) lançou 150 km³ de material na atmosfera. A poeira bloqueou o sol, causando queda de temperatura global e fome em vários continentes.', dica: 'Um vulcão mudou o clima global' },
    { emoji: '⚡', frente: 'Por que erupções vulcânicas criam relâmpagos?', verso: 'Partículas de cinza e gelo se chocam na nuvem de erupção, criando cargas estáticas. Os relâmpagos vulcânicos são causados por eletricidade estática, igual ao trovão normal!', dica: 'Plasma no vulcão!' },
    { emoji: '🌺', frente: 'Por que as ilhas do Havaí têm forma de cadeia?', verso: 'Uma pluma de magma fixa (ponto quente) perfura a placa tectônica. A placa se move, mas a pluma fica. Cada ilha é um vulcão mais antigo que o anterior!', dica: 'A pluma ficou, a placa passou' },
  ],

  tecnologia: [
    { emoji: '💻', frente: 'Quem inventou a World Wide Web (www)?', verso: 'Tim Berners-Lee, em 1991, no CERN (Suíça). Ele poderia ter patenteado e ficado trilionário — escolheu dar de graça para o mundo.', dica: 'Web ≠ Internet' },
    { emoji: '🔢', frente: 'O que é código binário?', verso: 'Sistema numérico com apenas 0 e 1 (ligado/desligado). Todo computador usa isso: textos, fotos, vídeos — tudo são sequências de 0s e 1s.', dica: '01001000 01001001 = HI' },
    { emoji: '⚡', frente: 'O que é um transistor e por que é tão importante?', verso: 'Minúsculo interruptor eletrônico que liga/desliga 1 bilhão de vezes por segundo. Um chip moderno tem bilhões deles — a base de todo computador.', dica: 'Igual ao 0 e 1 em hardware' },
    { emoji: '🤖', frente: 'Como a IA aprende a reconhecer imagens?', verso: 'Vê milhões de fotos rotuladas por humanos. Ajusta parâmetros matemáticos até errar menos. Não "entende" — encontra padrões estatísticos nos pixels.', dica: 'Padrões, não compreensão' },
    { emoji: '🌐', frente: 'O que é latência na internet?', verso: 'Tempo que um dado leva para ir de A a B e voltar. Medido em milissegundos (ms). Menor latência = internet mais "responsiva". Jogos online são muito sensíveis a latência alta.', dica: 'Velocidade ≠ latência' },
    { emoji: '🔐', frente: 'Como funciona o cadeado verde do HTTPS?', verso: 'Criptografia assimétrica: o site tem uma chave pública (para codificar) e uma privada (para decodificar). Só ele lê o que você enviou. Ninguém no meio consegue interceptar.', dica: 'S de Secure em HTTPS' },
  ],
  ...
  arte: [
    { emoji: '🖼️', frente: 'Por que o sorriso da Mona Lisa parece mudar?', verso: 'Leonardo usou sfumato — bordas difusas. As sombras dos cantos da boca ativam diferentes células do olho: visão central (séria) vs periférica (sorridente).', dica: 'Ilusão óptica intencional' },
    { emoji: '🎵', frente: 'Como Beethoven compôs sendo surdo?', verso: 'Visualizava os sons internamente (memória auditiva). Também apoiava a mandíbula no piano para sentir as vibrações. A 9ª Sinfonia foi toda composta em surdez total.', dica: '1824 — surdo há 26 anos' },
    { emoji: '🎬', frente: 'Qual foi o primeiro filme da história?', verso: '"A Saída dos Operários da Fábrica Lumière" (1895, 46 segundos). Os irmãos Lumière também filmaram um trem chegando — o público fugiu achando que era real!', dica: 'Cinema = 1895, Paris' },
    { emoji: '🎨', frente: 'O que é impressionismo na pintura?', verso: 'Movimento do séc. 19 que captura a "impressão" de um momento com pinceladas rápidas e cores vivas, ao invés de detalhes precisos. Monet, Renoir, Degas.', dica: 'Nome foi uma piada virou estilo' },
    { emoji: '✏️', frente: 'Leonardo da Vinci era famoso principalmente por quê?', verso: 'Por ser gênio em TUDO: pintor (Mona Lisa), escultor, arquiteto, músico, matemático, engenheiro e cientista. O maior polímata (multitalentoso) da história.', dica: 'Homo universalis = Homem universal' },
  ],

  historia_brasil: [
    { emoji: '⛵', frente: 'Quando e por quem o Brasil foi "descoberto" pelos europeus?', verso: '22 de abril de 1500, por Pedro Álvares Cabral. Mas os povos indígenas já habitavam o território há pelo menos 12.000 anos — para eles não foi descoberta.', dica: 'Brasil já era "ocupado"' },
    { emoji: '👑', frente: 'O que aconteceu em 7 de setembro de 1822?', verso: 'Dom Pedro I proclamou a Independência do Brasil às margens do Riacho do Ipiranga, em São Paulo. O Brasil se tornou Império, único da América do Sul.', dica: 'Independência ou morte!' },
  ...
  filosofia: [
    { emoji: '🤔', frente: 'O que disse Descartes para provar que existe?', verso: '"Cogito, ergo sum" — Penso, logo existo. Se estou duvidando, estou pensando. E se estou pensando, existo para pensar. É a base do racionalismo filosófico.', dica: 'A única certeza inabalável' },
    { emoji: '⚖️', frente: 'O que é o Dilema do Bonde (Trolley Problem)?', verso: 'Bonde desgovernado vai matar 5 pessoas; você pode desviar para matar 1. O que é mais ético? Não há resposta certa — é para explorar valores morais e ética utilitária.', dica: 'Utilidade vs. dever moral' },
    { emoji: '🌐', frente: 'O que é privacidade de dados e por que importa?', verso: 'Seus dados (localização, hábitos, conversas) valem dinheiro para empresas. "Quando o produto é gratuito, o produto é você." Privacidade é um direito fundamental, não luxo.', dica: 'LGPD: Lei Geral de Proteção de Dados' },
    { emoji: '🤖', frente: 'O que é o Teste de Turing?', verso: 'Proposto em 1950: se uma máquina consegue conversar de forma que um humano não consiga distingui-la de outro humano, ela pode ser considerada inteligente.', dica: 'ChatGPT passa facilmente hoje' },
    { emoji: '❓', frente: 'O que é o "Paradoxo do Navio de Teseu"?', verso: 'Se trocamos peça por peça de um navio até nenhuma original restar, é o mesmo navio? Questiona o que dá identidade às coisas — e às pessoas (suas células se renovam!).',  dica: 'Suas células se renovam a cada 7 anos' },
  ],
  ...
  transporte: [
    ...
    { emoji: '🚗', frente: 'O que é um carro elétrico e como funciona?', verso: 'Motor elétrico converte energia da bateria em movimento. Não precisa de câmbio (torque constante), tem uma peça móvel vs. 200+ do motor a combustão, e regenera energia ao frear.', dica: 'Eficiência: 90% vs. 25% do motor a explosão' },
    { emoji: '🛸', frente: 'Qual é a velocidade mínima para escapar da gravidade terrestre?', verso: '11,2 km/s (40.320 km/h) — velocidade de escape! Menos que isso e o objeto cai de volta. A SpaceX alcança isso com foguetes Falcon 9, queimando 200 toneladas de combustível.', dica: 'Sonho da humanidade realizado desde 1969' },
  ],
}
